  ...
  // ────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Тип занятия",
        type: "enum",
        sqlExpression: "CASE se.event_type WHEN 'theory' THEN 'Теория' WHEN 'practice' THEN 'Практика' WHEN 'assessment' THEN 'Аттестация' ELSE 'Другое' END",
        requiredJoins: ["schedule_events"],
        allowedAggregations: ["none", "count"],
        defaultAggregation: "none",
      ...
      },
      {
        ...
        type: "text",
        sqlExpression: "TIME_FORMAT(se.end_time, '%H:%i')",
        requiredJoins: ["schedule_events"],
        allowedAggregations: ["none", "list", "count_distinct"],
        defaultAggregation: "none",
      },
