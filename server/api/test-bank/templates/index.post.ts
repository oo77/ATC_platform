...
export default defineEventHandler(async (event) => {
  try {
    ...
    if (body.questions_mode === "random") {
      ...
      const availableQuestions = await getQuestionsCountByBankId(
        body.bank_id,
        true
      );
    ...
    const template = await createTestTemplate(
      {
        ...
        questions_mode: body.questions_mode || ("all" as any),
        ...
        show_results: body.show_results || ("immediately" as any),
