  ...
  <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
      ...
      <div class="flex gap-6">
        ...
        >
          ...
          <span
            ...
            class="absolute bottom-0 left-0 w-full h-0.5 bg-primary rounded-t-sm"
          ></span>
        </button>
        <button
          @click="
    ...
    <div class="bg-white dark:bg-boxdark rounded-xl shadow-md p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <!-- Статус (скрыт для архива) -->
        <div v-if="!filters.isArchived">
          <label
            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
          >
            Статус (Активность)
    ...
    <div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden">
      ...
      >
        ...
        <p v-if="!filters.isArchived" class="mt-2">
          Создайте первую группу, нажав кнопку "Создать группу"
        </p>
        <p v-else class="mt-2">В архиве пока нет групп</p>
      </div>
        ...
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            >
              ...
              <td class="px-6 py-4">
                <span
                  class="inline-flex items-center rounded-full bg-gray-100 dark:bg-gray-700 px-2.5 py-0.5 text-sm font-medium text-gray-800 dark:text-gray-200"
                >
