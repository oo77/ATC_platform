        ...
        <div class="relative px-8 pb-8">
          ...
          <div class="flex items-end gap-6 -mt-16 mb-6">
            <div class="relative">
              ...
              <div
                class="absolute -bottom-2 -right-2 h-10 w-10 rounded-full border-4 border-white dark:border-boxdark flex items-center justify-center"
                :class="[
                  userData.role === 'ADMIN'
                    ? 'bg-danger'
...
const loadUser = async () => {
  ...
  try {
    ...
    error.value =
      err?.data?.message || err?.message || "Ошибка загрузки пользователя";
  } finally {
