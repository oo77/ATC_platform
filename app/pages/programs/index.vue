  ...
  <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    >
      ...
      <UiButton
        ...
        @click="navigateTo('/programs/create')"
    ...
    <div class="bg-white dark:bg-boxdark rounded-xl shadow-md p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <!-- Статус (скрываем в архиве, или оставляем) - Скроем для архива, там все неактивные обычно, или статус не важен -->
    ...
    <div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden">
      ...
      >
        ...
        <p class="mt-2">
          Создайте первую учебную программу, нажав кнопку "Создать учебную
          программу"
        </p>
      </div>
