<template>
  <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-2 mb-6">
      ...
      >
        ...
        <div class="p-6">
          ...
          <div
            v-else-if="!organizationChartData.series.length"
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-2 mb-6">
      ...
      >
        ...
        <div class="p-6">
          ...
          <div
            v-else-if="!stats?.topInstructors?.length"
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="py-3">
                    <div class="flex items-center gap-3">
                      <div
                        class="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center text-white text-xs font-bold"
                      >
                        {{ getInitials(instructor.name) }}
                      </div>
                      <span
                        class="font-medium text-black dark:text-white truncate max-w-[150px]"
      ...
      >
        ...
        <div class="p-6">
          ...
          <div
            v-else-if="!currentTopCourses?.length"
            class="flex flex-col items-center justify-center py-8 text-center"
          >
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-3 mb-6">
      ...
      >
        <div
          class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center gap-3"
        >
          <div
            class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center"
          >
        ...
        <div class="p-6">
          ...
          <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer"
            ...
            >
              ...
              <div
                class="h-12 w-12 rounded-full bg-success/10 flex items-center justify-center"
              >
            ...
            >
              ...
              <div
                class="h-12 w-12 rounded-full bg-warning/10 flex items-center justify-center"
              >
            ...
            >
              ...
              <div
                class="h-12 w-12 rounded-full bg-info/10 flex items-center justify-center"
              >
      ...
      >
        ...
        <div class="p-6">
          ...
          <div
            v-else-if="!stats?.systemAlerts?.length"
            class="flex flex-col items-center justify-center py-8 text-center"
          >
            <div
              class="h-12 w-12 rounded-full bg-success/10 flex items-center justify-center mb-3"
            >
          ...
          <div v-else class="flex flex-col gap-3">
            ...
            >
              ...
              <IconsInfoCircleIcon
                ...
                class="w-5 h-5 text-info flex-shrink-0"
              />
              <IconsErrorIcon
