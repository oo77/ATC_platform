<template>
  <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
              ...
              >
                <div class="flex-1">
                  ...
                  <p class="text-sm text-gray-500 mt-1">
                    ...
                    <span v-if="lesson.classroom_name">
                      • Ауд. {{ lesson.classroom_name }}</span
                    >
                    <span v-if="lesson.student_count">
                      • {{ lesson.student_count }} студентов</span
                    >
                  </p>
                </div>
                <NuxtLink
            ...
            >
              ...
              <div class="flex items-center justify-between text-xs">
                <span class="text-gray-400"
                  >{{ group.student_count }} студентов</span
                >
                <span
                  class="font-medium"
                  :class="
              ...
              <div
                class="mt-2 relative h-1.5 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden"
              >
                <div
    ...
    <!-- Отчётность инструктора -->
    <div class="mt-6 grid grid-cols-1 gap-6">
      <!-- Отчётность по часам -->
      <InstructorsHoursStats
        v-if="user?.instructorId"
        :instructor-id="user.instructorId"
        :initial-load="true"
      />
