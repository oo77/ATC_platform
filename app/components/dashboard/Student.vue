<template>
  <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
      <!-- Ближайшие занятия -->
      <div
        class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden xl:col-span-2"
      >
        <div
              ...
              <div class="flex justify-between items-start">
                <div class="flex-1">
                  <div class="flex items-center gap-2 mb-1">
                    ...
                    <span
                      v-if="
                        event.allowed_student_ids || event.original_event_id
                      "
                      class="inline-flex items-center gap-1 rounded-full bg-purple-100 dark:bg-purple-900/30 px-2 py-0.5 text-xs font-medium text-purple-700 dark:text-purple-300"
                      title="Занятие для перездачи"
                    >
                      <svg
                        class="w-3 h-3"
                        fill="none"
                  ...
                  <p class="text-sm font-medium text-gray-500">
                    {{ event.course_name }}
                    <span v-if="event.classroom_name" class="ml-1"
                      >• Ауд. {{ event.classroom_name }}</span
                    >
                  </p>
                </div>
      ...
      >
        ...
        <div class="p-6">
          <div
            v-if="!stats?.upcomingDeadlines?.length"
    ...
    >
      ...
      >
        ...
        <NuxtLink to="/my-courses" class="text-sm text-primary hover:underline"
          >Все курсы</NuxtLink
        >
      </div>
      <div class="p-6">
        <div
          v-if="!stats?.activeCourses?.length"
          class="text-center text-gray-500 py-4"
        >
        ...
        >
          ...
          >
            <h4 class="font-bold text-black dark:text-white mb-1">
              {{ course.course_name }}
            </h4>
            <p class="text-sm text-gray-500 mb-3">
              Группа: {{ course.group_code }}
            </p>
            ...
            <div
              class="relative h-2 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden"
            >
              <div
        ...
        <div class="flex flex-col gap-3">
          ...
          >
            ...
            <div class="text-right">
              ...
              <p v-if="grade.comment" class="text-xs text-gray-500 mt-1">
                {{ grade.comment }}
              </p>
            </div>
          </div>
