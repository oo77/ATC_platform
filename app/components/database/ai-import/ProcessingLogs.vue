<template>
  ...
  >
    ...
    >
      <h3 class="text-lg font-medium text-gray-900">История импортов</h3>
      <div class="flex items-center space-x-2">
        <!-- Refresh Button -->
        <button
          @click="$emit('refresh')"
          class="p-2 text-gray-500 hover:text-blue-600 rounded-full hover:bg-white transition-colors"
        >
          <svg
