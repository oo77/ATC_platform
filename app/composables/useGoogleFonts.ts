...
// Шрифты доступные на сервере (server/assets/fonts/*.ttf)
// При добавлении нового шрифта — сначала скопируй TTF в server/assets/fonts/,
// затем добавь его сюда.
export const GOOGLE_FONTS: { name: string; weights: number[] }[] = [
  ...
  { name: "Fira Sans", weights: [400, 700] },
...
export const ALL_FONTS = [...GOOGLE_FONTS.map((f) => f.name), ...SYSTEM_FONTS];
