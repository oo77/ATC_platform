...
import { _ as __nuxt_component_2, a as __nuxt_component_3 } from './StudentCertificatesModal-BYeC1Vsm.mjs';
...
import { defineComponent, ref, computed, mergeProps, withCtx, createBlock, createVNode, openBlock, unref, createTextVNode, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    const getExpiryStatus = (expiryDate) => {
      ...
      const daysUntilExpiry = Math.ceil(
        (expiry.getTime() - now.getTime()) / (1e3 * 60 * 60 * 24)
      );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isCertificateDetailModalOpen.value && selectedCertificate.value) {
        _push(ssrRenderComponent(_component_DatabaseCertificateDetailModal, {
          certificate: certificateDetailData.value,
...
//# sourceMappingURL=_id_-C3CDdhea.mjs.map
