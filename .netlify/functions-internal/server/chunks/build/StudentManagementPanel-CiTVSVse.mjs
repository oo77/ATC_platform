import { _ as __nuxt_component_0$1 } from './nuxt-link-lE24s-NV.mjs';
...
import { _ as __nuxt_component_0$2 } from './Pagination-DWMrBbMe.mjs';
import { _ as __nuxt_component_2$1, a as __nuxt_component_3 } from './StudentCertificatesModal-BYeC1Vsm.mjs';
...
const __nuxt_component_2 = Object.assign(_sfc_main$1, { __name: "DatabaseStudentTable" });
...
Пароль: ${response.generatedPassword}`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiButton = __nuxt_component_1;
      const _component_DatabaseStudentTable = __nuxt_component_2;
      const _component_UiPagination = __nuxt_component_0$2;
      const _component_DatabaseStudentFormModal = __nuxt_component_2$1;
...
//# sourceMappingURL=StudentManagementPanel-CiTVSVse.mjs.map
