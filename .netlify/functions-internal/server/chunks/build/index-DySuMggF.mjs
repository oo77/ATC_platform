...
import { C as CalenderIcon, A as AcademicCapIcon, a as ClipboardCheckIcon, b as CertificateIcon, I as InfoCircleIcon, U as UserGroupIcon, c as UserCircleIcon, S as SettingsIcon, G as GridIcon } from './GridIcon-BLZ9gkYi.mjs';
...
import { u as useHead, a as useAuth, b as useRouter, _ as __nuxt_component_0$1 } from './server.mjs';
...
const __nuxt_component_17 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$i, [["ssrRender", _sfc_ssrRender$a]]), { __name: "IconsWarningIcon" });
const _sfc_main$h = {};
...
const __nuxt_component_16 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$9]]), { __name: "IconsCheckIcon" });
const _sfc_main$g = {};
...
const __nuxt_component_8$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$8]]), { __name: "IconsSupportIcon" });
const _sfc_main$f = {};
...
const __nuxt_component_8 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$7]]), { __name: "IconsBarChartIcon" });
const _sfc_main$e = {};
...
const __nuxt_component_15$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$6]]), { __name: "IconsBellIcon" });
const _sfc_main$d = {};
...
const __nuxt_component_19 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$5]]), { __name: "IconsErrorIcon" });
const _sfc_main$c = {};
...
const __nuxt_component_13 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$4]]), { __name: "IconsChevronRightIcon" });
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconsCheckIcon = __nuxt_component_16;
      ...
      const _component_IconsBellIcon = __nuxt_component_15$1;
      ...
      if (!stats.value?.upcomingEvents?.length) {
        ...
        ssrRenderList(stats.value.upcomingEvents, (event) => {
          _push(`<div class="flex flex-col gap-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-4"><div class="flex justify-between items-start"><div><h4 class="text-lg font-bold text-black dark:text-white">${ssrInterpolate(event.title)}</h4><p class="text-sm font-medium text-gray-500">${ssrInterpolate(event.course_name)} `);
      ...
      if (notifications.value?.length) {
        ...
        ssrRenderList(notifications.value, (notification) => {
          _push(`<div class="${ssrRenderClass([notification.is_read ? "bg-gray-50 dark:bg-gray-800/50" : "bg-primary/5 border border-primary/20", "flex items-start gap-3 p-3 rounded-lg transition-colors"])}">`);
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        ssrRenderList(stats.value.groups, (group) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<h4 class="font-bold text-black dark:text-white mb-1"${_scopeId}>${ssrInterpolate(group.code)}</h4><p class="text-sm text-gray-500 mb-2"${_scopeId}>${ssrInterpolate(group.course_name)}</p><div class="flex items-center justify-between text-xs"${_scopeId}><span class="text-gray-400"${_scopeId}>${ssrInterpolate(group.student_count)} студентов</span><span class="${ssrRenderClass([group.attendance_rate >= 80 ? "text-success" : group.attendance_rate >= 60 ? "text-warning" : "text-danger", "font-medium"])}"${_scopeId}> Посещаемость: ${ssrInterpolate(group.attendance_rate)}% </span></div><div class="mt-2 relative h-1.5 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden"${_scopeId}><div class="${ssrRenderClass([group.attendance_rate >= 80 ? "bg-success" : group.attendance_rate >= 60 ? "bg-warning" : "bg-danger", "absolute left-0 h-full rounded-full transition-all"])}" style="${ssrRenderStyle({ width: `${group.attendance_rate}%` })}"${_scopeId}></div></div>`);
              } else {
                return [
                  ...
                  createVNode("div", { class: "flex items-center justify-between text-xs" }, [
                    ...
                    createVNode("span", {
                      class: ["font-medium", group.attendance_rate >= 80 ? "text-success" : group.attendance_rate >= 60 ? "text-warning" : "text-danger"]
                  ...
                  createVNode("div", { class: "mt-2 relative h-1.5 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden" }, [
                    createVNode("div", {
                      class: ["absolute left-0 h-full rounded-full transition-all", group.attendance_rate >= 80 ? "bg-success" : group.attendance_rate >= 60 ? "bg-warning" : "bg-danger"],
      ...
      _push(`<div class="mt-6 rounded-lg bg-white dark:bg-boxdark p-6 shadow-md"><div class="flex items-center gap-3 mb-4"><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg></div><h3 class="text-lg font-semibold text-black dark:text-white">Быстрые действия</h3></div><div class="flex flex-wrap gap-3"><!--[-->`);
      ssrRenderList(quickActions, (action) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: action.to,
          to: action.to,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (action.icon === "calendar") {
                _push2(ssrRenderComponent(_component_IconsCalenderIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else if (action.icon === "group") {
                _push2(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else if (action.icon === "user") {
                _push2(ssrRenderComponent(_component_IconsUserCircleIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
              _push2(` ${ssrInterpolate(action.label)}`);
              ...
              return [
                action.icon === "calendar" ? (openBlock(), createBlock(_component_IconsCalenderIcon, {
                  key: 0,
                  class: "w-4 h-4"
                })) : action.icon === "group" ? (openBlock(), createBlock(_component_IconsUserGroupIcon, {
                  key: 1,
                  class: "w-4 h-4"
                })) : action.icon === "user" ? (openBlock(), createBlock(_component_IconsUserCircleIcon, {
                  key: 2,
                  class: "w-4 h-4"
                })) : createCommentVNode("", true),
                createTextVNode(" " + toDisplayString(action.label), 1)
...
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$3]]), { __name: "IconsPieChartIcon" });
const _sfc_main$8 = {
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-c7ea2314"]]);
const _sfc_main$6 = {};
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ChartsDonutChart = _sfc_main$8;
      const _component_IconsBarChartIcon = __nuxt_component_8;
      ...
      const _component_IconsArchiveIcon = __nuxt_component_15;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10" }, _attrs))} data-v-0c7364a3><div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between" data-v-0c7364a3><div data-v-0c7364a3><h2 class="text-title-md2 font-bold text-black dark:text-white" data-v-0c7364a3> Добрый день, ${ssrInterpolate(unref(user)?.name || "Менеджер")}! </h2><p class="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1" data-v-0c7364a3>${ssrInterpolate(unref(currentDate))} `);
      if (stats.value?.activeGroups > 0) {
        _push(`<span data-v-0c7364a3> • В работе ${ssrInterpolate(stats.value.activeGroups)} групп(ы) </span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</p></div>`);
      ...
      _push(`</div><div class="grid grid-cols-1 gap-4 md:grid-cols-4 mb-6" data-v-0c7364a3><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-0c7364a3><div class="flex items-center gap-4" data-v-0c7364a3><div class="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "w-6 h-6 text-primary" }, null, _parent));
      _push(`</div><div data-v-0c7364a3><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-0c7364a3>Активные группы</h3><p class="text-2xl font-bold text-black dark:text-white" data-v-0c7364a3>${ssrInterpolate(stats.value?.activeGroups || 0)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-0c7364a3><div class="flex items-center gap-4" data-v-0c7364a3><div class="flex h-12 w-12 items-center justify-center rounded-full bg-success/10" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsUserCircleIcon, { class: "w-6 h-6 text-success" }, null, _parent));
      _push(`</div><div data-v-0c7364a3><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-0c7364a3>Студенты на курсах</h3><p class="text-2xl font-bold text-black dark:text-white" data-v-0c7364a3>${ssrInterpolate(stats.value?.studentsOnCourses || 0)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-0c7364a3><div class="flex items-center gap-4" data-v-0c7364a3><div class="flex h-12 w-12 items-center justify-center rounded-full bg-warning/10" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsClipboardCheckIcon, { class: "w-6 h-6 text-warning" }, null, _parent));
      _push(`</div><div data-v-0c7364a3><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-0c7364a3>Тесты сегодня</h3><p class="text-2xl font-bold text-black dark:text-white" data-v-0c7364a3>${ssrInterpolate(stats.value?.testsToday || 0)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-0c7364a3><div class="flex items-center gap-4" data-v-0c7364a3><div class="flex h-12 w-12 items-center justify-center rounded-full bg-info/10" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsCertificateIcon, { class: "w-6 h-6 text-info" }, null, _parent));
      _push(`</div><div data-v-0c7364a3><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-0c7364a3>К выдаче сертификатов</h3><p class="text-2xl font-bold text-black dark:text-white" data-v-0c7364a3>${ssrInterpolate(stats.value?.certificatesPending || 0)}</p></div></div></div></div><div class="grid grid-cols-1 gap-6 xl:grid-cols-2 mb-6" data-v-0c7364a3><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-0c7364a3><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center justify-between" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsPieChartIcon, { class: "w-5 h-5 text-primary" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-0c7364a3>Студенты по курсам</h3></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/groups",
        class: "text-sm text-primary hover:underline"
      }, {
      ...
      _push(`</div><div class="p-6" data-v-0c7364a3>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-16" data-v-0c7364a3><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-0c7364a3></div></div>`);
      } else if (!coursesChartData.value.series.length) {
        _push(`<div class="flex flex-col items-center justify-center py-16 text-center" data-v-0c7364a3>`);
        _push(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "h-12 w-12 text-gray-300 mb-3" }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-0c7364a3>Нет данных о студентах</p></div>`);
      } else {
      ...
      _push(`</div></div><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-0c7364a3><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center justify-between flex-wrap gap-3" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-success/10 flex items-center justify-center" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsBarChartIcon, { class: "w-5 h-5 text-success" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-0c7364a3>Сертификаты</h3></div><div class="flex items-center gap-3" data-v-0c7364a3><div class="flex gap-2 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg" data-v-0c7364a3><!--[-->`);
      ssrRenderList(certificatePeriods, (period) => {
        _push(`<button class="${ssrRenderClass([certificatePeriod.value === period.value ? "bg-success text-white shadow-md transform scale-105" : "text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700", "px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-300"])}" data-v-0c7364a3>${ssrInterpolate(period.label)}</button>`);
      });
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/certificates",
      ...
      _push(`</div></div><div class="p-6" data-v-0c7364a3>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-16" data-v-0c7364a3><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-0c7364a3></div></div>`);
        ...
        _push(`<p class="text-sm text-gray-500" data-v-0c7364a3>Нет данных о сертификатах</p></div>`);
      } else {
        _push(`<div class="${ssrRenderClass([certificateTransitioning.value ? "opacity-50" : "opacity-100", "transition-opacity duration-500"])}" data-v-0c7364a3>`);
      ...
      _push(`</div></div></div><div class="grid grid-cols-1 gap-6 xl:grid-cols-2 mb-6" data-v-0c7364a3><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-0c7364a3><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center justify-between" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-info/10 flex items-center justify-center" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsAcademicCapIcon, { class: "w-5 h-5 text-info" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-0c7364a3>Популярные курсы</h3></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/groups",
        class: "text-sm text-primary hover:underline"
      }, {
      ...
      _push(`</div><div class="p-6" data-v-0c7364a3>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-8" data-v-0c7364a3><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-0c7364a3></div></div>`);
      } else if (!stats.value?.topCourses?.length) {
        _push(`<div class="flex flex-col items-center justify-center py-8 text-center" data-v-0c7364a3>`);
        _push(ssrRenderComponent(_component_IconsAcademicCapIcon, { class: "h-12 w-12 text-gray-300 mb-3" }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-0c7364a3>Нет данных о курсах</p></div>`);
      } else {
        _push(`<div class="space-y-4" data-v-0c7364a3><!--[-->`);
        ssrRenderList(stats.value.topCourses, (course, index) => {
          _push(`<div class="flex items-center gap-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer" data-v-0c7364a3><span class="${ssrRenderClass([getRankClass(index), "flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold flex-shrink-0"])}" data-v-0c7364a3>${ssrInterpolate(index + 1)}</span><div class="flex-1 min-w-0" data-v-0c7364a3><p class="font-medium text-black dark:text-white truncate" data-v-0c7364a3>${ssrInterpolate(course.name)}</p><p class="text-xs text-gray-500" data-v-0c7364a3>${ssrInterpolate(course.code)}</p></div><div class="text-right flex-shrink-0" data-v-0c7364a3><p class="text-lg font-bold text-info" data-v-0c7364a3>${ssrInterpolate(course.students_count)}</p><p class="text-xs text-gray-500" data-v-0c7364a3> студентов </p></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></div><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-0c7364a3><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex justify-between items-center" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "w-5 h-5 text-primary" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-0c7364a3>Группы в работе</h3></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/groups",
        class: "text-sm text-primary hover:underline"
      }, {
      ...
      if (loading.value) {
        ...
        _push(`<div class="text-center text-gray-500 py-4" data-v-0c7364a3> Нет активных групп </div>`);
      } else {
        _push(`<div class="flex flex-col gap-3" data-v-0c7364a3><!--[-->`);
        ssrRenderList(stats.value.groups, (group) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            key: group.id,
            to: `/groups/${group.id}`,
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex justify-between items-start mb-2" data-v-0c7364a3${_scopeId}><div data-v-0c7364a3${_scopeId}><h4 class="font-bold text-black dark:text-white" data-v-0c7364a3${_scopeId}>${ssrInterpolate(group.code)}</h4><p class="text-xs text-gray-500" data-v-0c7364a3${_scopeId}>${ssrInterpolate(group.course_name)}</p></div><span class="text-xs font-medium px-2 py-0.5 rounded-full bg-primary/10 text-primary" data-v-0c7364a3${_scopeId}>${ssrInterpolate(group.student_count)} студ. </span></div><div class="flex items-center justify-between text-xs mb-1" data-v-0c7364a3${_scopeId}><span class="text-gray-600 dark:text-gray-400" data-v-0c7364a3${_scopeId}>Прогресс группы</span><span class="font-medium text-primary" data-v-0c7364a3${_scopeId}>${ssrInterpolate(group.progress)}%</span></div><div class="relative h-1.5 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden" data-v-0c7364a3${_scopeId}><div class="absolute left-0 h-full rounded-full bg-primary transition-all duration-1000" style="${ssrRenderStyle({ width: `${group.progress}%` })}" data-v-0c7364a3${_scopeId}></div></div><div class="mt-2 text-right" data-v-0c7364a3${_scopeId}><span class="text-xs text-gray-400" data-v-0c7364a3${_scopeId}>До ${ssrInterpolate(formatShortDate(group.end_date))}</span></div>`);
              } else {
                return [
      ...
      _push(`</div></div></div><div class="grid grid-cols-1 gap-6 xl:grid-cols-3 mb-6" data-v-0c7364a3><div class="xl:col-span-2 rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-0c7364a3><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex justify-between items-center" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-success/10 flex items-center justify-center" data-v-0c7364a3>`);
      _push(ssrRenderComponent(_component_IconsCalenderIcon, { class: "w-5 h-5 text-success" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-0c7364a3>Сегодня</h3></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/schedule",
        class: "text-sm text-primary hover:underline"
      }, {
      ...
      if (loading.value) {
        ...
        _push(`<div class="text-center text-gray-500 py-4" data-v-0c7364a3> Нет занятий на сегодня </div>`);
      } else {
        _push(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-0c7364a3><!--[-->`);
        ssrRenderList(stats.value.todaySchedule, (event) => {
          _push(`<div class="flex flex-col gap-2 p-3 rounded-lg border border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors" data-v-0c7364a3><div class="flex items-center justify-between" data-v-0c7364a3><span class="text-sm font-bold text-primary bg-primary/10 px-2 py-0.5 rounded" data-v-0c7364a3>${ssrInterpolate(formatTime(event.start_time))}</span><span class="${ssrRenderClass([getEventTypeClass(event.event_type), "inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium"])}" data-v-0c7364a3>${ssrInterpolate(getEventTypeLabel(event.event_type))}</span></div><h5 class="text-sm font-medium text-black dark:text-white truncate" data-v-0c7364a3>${ssrInterpolate(event.title)}</h5><div class="flex items-center gap-2 text-xs text-gray-500" data-v-0c7364a3>`);
          _push(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "w-3 h-3" }, null, _parent));
          _push(`<span data-v-0c7364a3>${ssrInterpolate(event.group_code)}</span>`);
          if (event.instructor_name) {
            _push(`<span class="flex items-center gap-1 border-l border-gray-300 pl-2 ml-1" data-v-0c7364a3> • ${ssrInterpolate(event.instructor_name)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
      ...
      if (stats.value?.groupsEndingSoon?.length) {
        _push(`<div class="rounded-lg bg-warning/5 border border-warning/30 shadow-md overflow-hidden" data-v-0c7364a3><div class="border-b border-warning/30 py-4 px-6 flex justify-between items-center" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-warning/10 flex items-center justify-center" data-v-0c7364a3>`);
        _push(ssrRenderComponent(_component_IconsWarningIcon, { class: "w-5 h-5 text-warning" }, null, _parent));
        _push(`</div><h3 class="text-lg font-semibold text-warning" data-v-0c7364a3> Завершаются скоро </h3><span class="bg-warning text-white text-xs px-2 py-0.5 rounded-full" data-v-0c7364a3>${ssrInterpolate(stats.value.groupsEndingSoon.length)}</span></div></div><div class="p-6" data-v-0c7364a3><div class="flex flex-col gap-3" data-v-0c7364a3><!--[-->`);
        ssrRenderList(stats.value.groupsEndingSoon, (group) => {
          _push(`<div class="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-boxdark border border-gray-200 dark:border-gray-700" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><span class="${ssrRenderClass([getDaysUntilEndClass(group.end_date), "flex h-2.5 w-2.5 rounded-full"])}" data-v-0c7364a3></span><div data-v-0c7364a3><h5 class="font-medium text-black dark:text-white text-sm" data-v-0c7364a3>${ssrInterpolate(group.code)}</h5><p class="text-xs text-gray-500" data-v-0c7364a3>${ssrInterpolate(formatDate(group.end_date))}</p></div></div><div class="text-right" data-v-0c7364a3>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        _push(`<div class="rounded-lg bg-danger/5 border border-danger/30 shadow-md overflow-hidden" data-v-0c7364a3><div class="border-b border-danger/30 py-4 px-6" data-v-0c7364a3><div class="flex items-center gap-3" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-danger/10 flex items-center justify-center" data-v-0c7364a3>`);
        _push(ssrRenderComponent(_component_IconsErrorIcon, { class: "w-5 h-5 text-danger" }, null, _parent));
        _push(`</div><h3 class="text-lg font-semibold text-danger" data-v-0c7364a3> Требуют внимания </h3></div></div><div class="p-6" data-v-0c7364a3><ul class="space-y-3" data-v-0c7364a3><!--[-->`);
        ssrRenderList(stats.value.alerts, (alert, index) => {
          _push(`<li class="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300" data-v-0c7364a3><span class="mt-1 h-1.5 w-1.5 rounded-full bg-danger flex-shrink-0" data-v-0c7364a3></span> ${ssrInterpolate(alert)}</li>`);
        });
        _push(`<!--]--></ul></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mt-6 rounded-lg bg-white dark:bg-boxdark p-6 shadow-md" data-v-0c7364a3><div class="flex items-center gap-3 mb-4" data-v-0c7364a3><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center" data-v-0c7364a3><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-0c7364a3><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" data-v-0c7364a3></path></svg></div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-0c7364a3>Быстрые действия</h3></div><div class="flex flex-wrap gap-3" data-v-0c7364a3><!--[-->`);
      ssrRenderList(quickActions, (action) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: action.to,
          to: action.to,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (action.icon === "plus") {
                _push2(ssrRenderComponent(_component_IconsPlusIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else if (action.icon === "archive") {
                _push2(ssrRenderComponent(_component_IconsArchiveIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else if (action.icon === "certificate") {
                _push2(ssrRenderComponent(_component_IconsCertificateIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else if (action.icon === "calendar") {
                _push2(ssrRenderComponent(_component_IconsCalenderIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              ...
              return [
                action.icon === "plus" ? (openBlock(), createBlock(_component_IconsPlusIcon, {
                  key: 0,
                  class: "w-4 h-4"
                })) : action.icon === "archive" ? (openBlock(), createBlock(_component_IconsArchiveIcon, {
                  key: 1,
                  class: "w-4 h-4"
                })) : action.icon === "certificate" ? (openBlock(), createBlock(_component_IconsCertificateIcon, {
                  key: 2,
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-0c7364a3"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10" }, _attrs))} data-v-8d5d5418><div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between" data-v-8d5d5418><div data-v-8d5d5418><h2 class="text-title-md2 font-bold text-black dark:text-white" data-v-8d5d5418> Добро пожаловать, ${ssrInterpolate(unref(user)?.name || "Администратор")}! </h2><p class="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1" data-v-8d5d5418>${ssrInterpolate(unref(currentDate))}</p></div>`);
      ...
      _push(`</div><div class="grid grid-cols-1 gap-4 md:grid-cols-4 mb-6" data-v-8d5d5418><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-8d5d5418><div class="flex items-center gap-4" data-v-8d5d5418><div class="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "w-6 h-6 text-primary" }, null, _parent));
      _push(`</div><div data-v-8d5d5418><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-8d5d5418>Всего студентов</h3><div class="flex items-center gap-2" data-v-8d5d5418><p class="text-2xl font-bold text-black dark:text-white" data-v-8d5d5418>${ssrInterpolate(stats.value?.totalStudents || 0)}</p>`);
      if (stats.value?.studentsTrend) {
        _push(`<span class="text-xs font-medium text-success" data-v-8d5d5418> +${ssrInterpolate(stats.value.studentsTrend)}% </span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-8d5d5418><div class="flex items-center gap-4" data-v-8d5d5418><div class="flex h-12 w-12 items-center justify-center rounded-full bg-success/10" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsInstructorIcon, { class: "w-6 h-6 text-success" }, null, _parent));
      _push(`</div><div data-v-8d5d5418><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-8d5d5418>Преподаватели</h3><p class="text-2xl font-bold text-black dark:text-white" data-v-8d5d5418>${ssrInterpolate(stats.value?.totalInstructors || 0)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-8d5d5418><div class="flex items-center gap-4" data-v-8d5d5418><div class="flex h-12 w-12 items-center justify-center rounded-full bg-warning/10" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "w-6 h-6 text-warning" }, null, _parent));
      _push(`</div><div data-v-8d5d5418><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-8d5d5418>Активные группы</h3><p class="text-2xl font-bold text-black dark:text-white" data-v-8d5d5418>${ssrInterpolate(stats.value?.activeGroups || 0)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md hover:shadow-lg transition-shadow cursor-pointer" data-v-8d5d5418><div class="flex items-center gap-4" data-v-8d5d5418><div class="flex h-12 w-12 items-center justify-center rounded-full bg-info/10" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsCertificateIcon, { class: "w-6 h-6 text-info" }, null, _parent));
      _push(`</div><div data-v-8d5d5418><h3 class="text-sm font-medium text-gray-600 dark:text-gray-400" data-v-8d5d5418>Сертификаты за месяц</h3><p class="text-2xl font-bold text-black dark:text-white" data-v-8d5d5418>${ssrInterpolate(stats.value?.certificatesThisMonth || 0)}</p></div></div></div></div><div class="grid grid-cols-1 gap-6 xl:grid-cols-2 mb-6" data-v-8d5d5418><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-8d5d5418><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center justify-between" data-v-8d5d5418><div class="flex items-center gap-3" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsPieChartIcon, { class: "w-5 h-5 text-primary" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Студенты по организациям</h3></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</div><div class="p-6" data-v-8d5d5418>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-16" data-v-8d5d5418><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-8d5d5418></div></div>`);
      } else if (!organizationChartData.value.series.length) {
        _push(`<div class="flex flex-col items-center justify-center py-16 text-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsUserGroupIcon, { class: "h-12 w-12 text-gray-300 mb-3" }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-8d5d5418>Нет данных об организациях</p></div>`);
      } else {
        _push(ssrRenderComponent(_component_ChartsDonutChart, {
      ...
      _push(`</div></div><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-8d5d5418><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center justify-between flex-wrap gap-3" data-v-8d5d5418><div class="flex items-center gap-3" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-success/10 flex items-center justify-center" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsBarChartIcon, { class: "w-5 h-5 text-success" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Сертификаты</h3></div><div class="flex items-center gap-3" data-v-8d5d5418><div class="flex gap-2 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg" data-v-8d5d5418><!--[-->`);
      ssrRenderList(certificatePeriods, (period) => {
        _push(`<button class="${ssrRenderClass([certificatePeriod.value === period.value ? "bg-success text-white shadow-md transform scale-105" : "text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700", "px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-300"])}" data-v-8d5d5418>${ssrInterpolate(period.label)}</button>`);
      });
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/certificates",
      ...
      _push(`</div></div><div class="p-6" data-v-8d5d5418>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-16" data-v-8d5d5418><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-8d5d5418></div></div>`);
      } else if (!currentCertificatesData.value.series[0]?.data?.length) {
        _push(`<div class="flex flex-col items-center justify-center py-16 text-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsCertificateIcon, { class: "h-12 w-12 text-gray-300 mb-3" }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-8d5d5418>Нет данных о сертификатах</p></div>`);
      } else {
        _push(`<div class="${ssrRenderClass([certificateTransitioning.value ? "opacity-50" : "opacity-100", "transition-opacity duration-500"])}" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_ChartsDynamicBarChart, {
          key: certificatePeriod.value,
      ...
      _push(`</div></div></div><div class="grid grid-cols-1 gap-6 xl:grid-cols-2 mb-6" data-v-8d5d5418><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-8d5d5418><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center justify-between" data-v-8d5d5418><div class="flex items-center gap-3" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-warning/10 flex items-center justify-center" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsInstructorIcon, { class: "w-5 h-5 text-warning" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Топ инструкторов по часам</h3></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/programs",
        class: "text-sm text-primary hover:underline"
      }, {
      ...
      _push(`</div><div class="p-6" data-v-8d5d5418>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-8" data-v-8d5d5418><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-8d5d5418></div></div>`);
      } else if (!stats.value?.topInstructors?.length) {
        _push(`<div class="flex flex-col items-center justify-center py-8 text-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsInstructorIcon, { class: "h-12 w-12 text-gray-300 mb-3" }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-8d5d5418>Нет данных об инструкторах</p></div>`);
      } else {
        _push(`<div class="overflow-x-auto" data-v-8d5d5418><table class="w-full text-sm" data-v-8d5d5418><thead data-v-8d5d5418><tr class="text-left text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700" data-v-8d5d5418><th class="pb-3 font-medium" data-v-8d5d5418>#</th><th class="pb-3 font-medium" data-v-8d5d5418>Инструктор</th><th class="pb-3 font-medium text-right" data-v-8d5d5418>Часы</th><th class="pb-3 font-medium text-right" data-v-8d5d5418>Занятий</th></tr></thead><tbody data-v-8d5d5418><!--[-->`);
        ssrRenderList(stats.value.topInstructors, (instructor, index) => {
          _push(`<tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors" data-v-8d5d5418><td class="py-3" data-v-8d5d5418><span class="${ssrRenderClass([getRankClass(index), "flex h-6 w-6 items-center justify-center rounded-full text-xs font-bold"])}" data-v-8d5d5418>${ssrInterpolate(index + 1)}</span></td><td class="py-3" data-v-8d5d5418><div class="flex items-center gap-3" data-v-8d5d5418><div class="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center text-white text-xs font-bold" data-v-8d5d5418>${ssrInterpolate(getInitials(instructor.name))}</div><span class="font-medium text-black dark:text-white truncate max-w-[150px]" data-v-8d5d5418>${ssrInterpolate(instructor.name)}</span></div></td><td class="py-3 text-right" data-v-8d5d5418><span class="font-bold text-warning" data-v-8d5d5418>${ssrInterpolate(instructor.hours)} ч</span></td><td class="py-3 text-right text-gray-600 dark:text-gray-400" data-v-8d5d5418>${ssrInterpolate(instructor.lessonsCount)}</td></tr>`);
        });
        _push(`<!--]--></tbody></table></div>`);
      }
      _push(`</div></div><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-8d5d5418><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center justify-between" data-v-8d5d5418><div class="flex items-center gap-3" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-info/10 flex items-center justify-center" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsAcademicCapIcon, { class: "w-5 h-5 text-info" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Топ курсов</h3></div><div class="flex gap-2" data-v-8d5d5418><button class="${ssrRenderClass([courseTab.value === "groups" ? "bg-primary text-white" : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700", "px-3 py-1 rounded-lg text-xs font-medium transition-colors"])}" data-v-8d5d5418> По группам </button><button class="${ssrRenderClass([courseTab.value === "students" ? "bg-primary text-white" : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700", "px-3 py-1 rounded-lg text-xs font-medium transition-colors"])}" data-v-8d5d5418> По слушателям </button></div></div><div class="p-6" data-v-8d5d5418>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-8" data-v-8d5d5418><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-8d5d5418></div></div>`);
      } else if (!currentTopCourses.value?.length) {
        _push(`<div class="flex flex-col items-center justify-center py-8 text-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsAcademicCapIcon, { class: "h-12 w-12 text-gray-300 mb-3" }, null, _parent));
        _push(`<p class="text-sm text-gray-500" data-v-8d5d5418>Нет данных о курсах</p></div>`);
      } else {
        _push(`<div class="space-y-4" data-v-8d5d5418><!--[-->`);
        ssrRenderList(currentTopCourses.value, (course, index) => {
          _push(`<div class="flex items-center gap-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer" data-v-8d5d5418><span class="${ssrRenderClass([getRankClass(index), "flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold flex-shrink-0"])}" data-v-8d5d5418>${ssrInterpolate(index + 1)}</span><div class="flex-1 min-w-0" data-v-8d5d5418><p class="font-medium text-black dark:text-white truncate" data-v-8d5d5418>${ssrInterpolate(course.name)}</p><p class="text-xs text-gray-500" data-v-8d5d5418>${ssrInterpolate(course.code)}</p></div><div class="text-right flex-shrink-0" data-v-8d5d5418><p class="text-lg font-bold text-info" data-v-8d5d5418>${ssrInterpolate(courseTab.value === "groups" ? course.groups_count : course.students_count)}</p><p class="text-xs text-gray-500" data-v-8d5d5418>${ssrInterpolate(courseTab.value === "groups" ? "групп" : "слушателей")}</p></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></div></div><div class="grid grid-cols-1 gap-6 xl:grid-cols-3 mb-6" data-v-8d5d5418><div class="xl:col-span-2 rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-8d5d5418><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center gap-3" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsBarChartIcon, { class: "w-5 h-5 text-primary" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Статистика системы</h3></div><div class="p-6" data-v-8d5d5418>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-8" data-v-8d5d5418><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-8d5d5418></div></div>`);
      } else {
        _push(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-8d5d5418><div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer" data-v-8d5d5418><div data-v-8d5d5418><p class="text-sm text-gray-500 dark:text-gray-400" data-v-8d5d5418>Всего пользователей</p><p class="text-2xl font-bold text-black dark:text-white mt-1" data-v-8d5d5418>${ssrInterpolate(stats.value?.totalUsers || 0)}</p></div><div class="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsUserCircleIcon, { class: "w-6 h-6 text-primary" }, null, _parent));
        _push(`</div></div><div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-800" data-v-8d5d5418><div data-v-8d5d5418><p class="text-sm text-gray-500 dark:text-gray-400" data-v-8d5d5418>Зарегистрировано сегодня</p><p class="text-2xl font-bold text-black dark:text-white mt-1" data-v-8d5d5418>${ssrInterpolate(stats.value?.todayRegistrations || 0)}</p></div><div class="h-12 w-12 rounded-full bg-success/10 flex items-center justify-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsPlusIcon, { class: "w-6 h-6 text-success" }, null, _parent));
        _push(`</div></div><div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-800" data-v-8d5d5418><div data-v-8d5d5418><p class="text-sm text-gray-500 dark:text-gray-400" data-v-8d5d5418>Активных сессий</p><p class="text-2xl font-bold text-black dark:text-white mt-1" data-v-8d5d5418>${ssrInterpolate(stats.value?.activeSessions || 0)}</p></div><div class="h-12 w-12 rounded-full bg-warning/10 flex items-center justify-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsGridIcon, { class: "w-6 h-6 text-warning" }, null, _parent));
        _push(`</div></div><div class="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer" data-v-8d5d5418><div data-v-8d5d5418><p class="text-sm text-gray-500 dark:text-gray-400" data-v-8d5d5418>Логов сегодня</p><p class="text-2xl font-bold text-black dark:text-white mt-1" data-v-8d5d5418>${ssrInterpolate(stats.value?.todayLogs || 0)}</p></div><div class="h-12 w-12 rounded-full bg-info/10 flex items-center justify-center" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsListIcon, { class: "w-6 h-6 text-info" }, null, _parent));
        _push(`</div></div></div>`);
      }
      _push(`</div></div><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden" data-v-8d5d5418><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex items-center gap-3" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-warning/10 flex items-center justify-center" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsBellIcon, { class: "w-5 h-5 text-warning" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Системные уведомления</h3></div><div class="p-6" data-v-8d5d5418>`);
      if (loading.value) {
        _push(`<div class="flex justify-center py-8" data-v-8d5d5418><div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-primary border-r-transparent" data-v-8d5d5418></div></div>`);
      } else if (!stats.value?.systemAlerts?.length) {
        _push(`<div class="flex flex-col items-center justify-center py-8 text-center" data-v-8d5d5418><div class="h-12 w-12 rounded-full bg-success/10 flex items-center justify-center mb-3" data-v-8d5d5418>`);
        _push(ssrRenderComponent(_component_IconsCheckIcon, { class: "h-6 w-6 text-success" }, null, _parent));
        _push(`</div><p class="text-sm text-gray-500" data-v-8d5d5418>Нет системных уведомлений</p></div>`);
      } else {
        _push(`<div class="flex flex-col gap-3" data-v-8d5d5418><!--[-->`);
        ssrRenderList(stats.value.systemAlerts, (alert, index) => {
          _push(`<div class="${ssrRenderClass([getAlertClass(alert.type), "flex items-start gap-3 p-3 rounded-lg cursor-pointer transition-transform hover:scale-[1.02]"])}" data-v-8d5d5418>`);
          ...
          _push(`<div class="flex-1" data-v-8d5d5418><p class="text-sm font-medium text-black dark:text-white" data-v-8d5d5418>${ssrInterpolate(alert.message)}</p>`);
          if (alert.action) {
            _push(`<p class="text-xs text-primary hover:underline cursor-pointer mt-1" data-v-8d5d5418>${ssrInterpolate(alert.action)}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
      ...
      _push(`</div></div></div><div class="rounded-lg bg-white dark:bg-boxdark shadow-md overflow-hidden mb-6" data-v-8d5d5418><div class="border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex justify-between items-center" data-v-8d5d5418><div class="flex items-center gap-3" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center" data-v-8d5d5418>`);
      _push(ssrRenderComponent(_component_IconsListIcon, { class: "w-5 h-5 text-primary" }, null, _parent));
      _push(`</div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Последние действия</h3></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/activity-logs",
        class: "text-sm text-primary hover:underline"
      }, {
      ...
      if (loading.value) {
        ...
        _push(`<div class="text-center text-gray-500 py-4" data-v-8d5d5418> Нет недавних действий </div>`);
      } else {
        _push(`<div class="grid grid-cols-1 md:grid-cols-2 gap-3" data-v-8d5d5418><!--[-->`);
        ssrRenderList(stats.value.recentActivities, (activity) => {
          _push(`<div class="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors" data-v-8d5d5418><span class="${ssrRenderClass([getActivityDotClass(activity.action), "flex h-2 w-2 rounded-full flex-shrink-0"])}" data-v-8d5d5418></span><div class="flex-1 min-w-0" data-v-8d5d5418><p class="text-sm text-black dark:text-white truncate" data-v-8d5d5418><span class="font-medium" data-v-8d5d5418>${ssrInterpolate(activity.user_name)}</span><span class="text-gray-500 mx-1" data-v-8d5d5418>•</span><span class="text-gray-600 dark:text-gray-400" data-v-8d5d5418>${ssrInterpolate(activity.action)}</span></p><p class="text-xs text-gray-500 mt-0.5" data-v-8d5d5418>${ssrInterpolate(formatRelativeTime(activity.created_at))}</p></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></div><div class="rounded-lg bg-white dark:bg-boxdark p-6 shadow-md" data-v-8d5d5418><div class="flex items-center gap-3 mb-4" data-v-8d5d5418><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center" data-v-8d5d5418><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-8d5d5418><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" data-v-8d5d5418></path></svg></div><h3 class="text-lg font-semibold text-black dark:text-white" data-v-8d5d5418>Быстрые действия</h3></div><div class="flex flex-wrap gap-3" data-v-8d5d5418><!--[-->`);
      ssrRenderList(quickActions, (action) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: action.to,
          to: action.to,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (action.icon === "plus") {
                ...
                _push2(ssrRenderComponent(_component_IconsAcademicCapIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else if (action.icon === "settings") {
                _push2(ssrRenderComponent(_component_IconsSettingsIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else if (action.icon === "list") {
                _push2(ssrRenderComponent(_component_IconsListIcon, { class: "w-4 h-4" }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
              _push2(` ${ssrInterpolate(action.label)}`);
              ...
              return [
                action.icon === "plus" ? (openBlock(), createBlock(_component_IconsPlusIcon, {
                  key: 0,
                  class: "w-4 h-4"
                })) : action.icon === "academic" ? (openBlock(), createBlock(_component_IconsAcademicCapIcon, {
                  key: 1,
                  class: "w-4 h-4"
                })) : action.icon === "settings" ? (openBlock(), createBlock(_component_IconsSettingsIcon, {
                  key: 2,
                  class: "w-4 h-4"
                })) : action.icon === "list" ? (openBlock(), createBlock(_component_IconsListIcon, {
                  key: 3,
                  class: "w-4 h-4"
                })) : createCommentVNode("", true),
                createTextVNode(" " + toDisplayString(action.label), 1)
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8d5d5418"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_DashboardStudent = _sfc_main$b;
      const _component_DashboardTeacher = _sfc_main$a;
...
//# sourceMappingURL=index-DySuMggF.mjs.map
