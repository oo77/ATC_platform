...
const TrashIcon = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender]]), { __name: "IconsTrashIcon" });
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "file-uploader" }, _attrs))} data-v-460c0dbf><div class="${ssrRenderClass([
        ...
        "cursor-pointer"
      ])}" data-v-460c0dbf><input type="file"${ssrRenderAttr("accept", __props.accept)}${ssrIncludeBooleanAttr(__props.multiple) ? " multiple" : ""} class="hidden" data-v-460c0dbf><div class="flex flex-col items-center justify-center gap-4 text-center" data-v-460c0dbf><div class="${ssrRenderClass([
        "flex h-16 w-16 items-center justify-center rounded-full transition-all",
        isDragging.value ? "bg-primary text-white scale-110" : "bg-gray-100 dark:bg-gray-800 text-gray-400"
      ])}" data-v-460c0dbf><svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-460c0dbf><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" data-v-460c0dbf></path></svg></div><div data-v-460c0dbf><p class="text-lg font-medium text-black dark:text-white" data-v-460c0dbf>${ssrInterpolate(isDragging.value ? "Отпустите файл" : "Перетащите файл сюда")}</p><p class="mt-1 text-sm text-gray-500 dark:text-gray-400" data-v-460c0dbf> или нажмите для выбора </p><p class="mt-2 text-xs text-gray-400 dark:text-gray-500" data-v-460c0dbf> Максимальный размер: ${ssrInterpolate(__props.maxSizeMb)} MB </p></div>`);
      if (isUploading.value) {
        _push(`<div class="w-full max-w-md" data-v-460c0dbf><div class="flex items-center justify-between mb-2" data-v-460c0dbf><span class="text-sm text-gray-600 dark:text-gray-400" data-v-460c0dbf>Загрузка...</span><span class="text-sm font-medium text-primary" data-v-460c0dbf>${ssrInterpolate(uploadProgress.value)}%</span></div><div class="h-2 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden" data-v-460c0dbf><div class="h-full bg-linear-to-r from-primary to-secondary transition-all duration-300" style="${ssrRenderStyle({ width: `${uploadProgress.value}%` })}" data-v-460c0dbf></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
      if (__props.showPreview && uploadedFiles.value.length > 0) {
        _push(`<div class="mt-4" data-v-460c0dbf><h4 class="text-sm font-medium text-black dark:text-white mb-3" data-v-460c0dbf> Загруженные файлы (${ssrInterpolate(uploadedFiles.value.length)}) </h4><div class="space-y-2" data-v-460c0dbf><!--[-->`);
        ssrRenderList(uploadedFiles.value, (file) => {
          _push(`<div class="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" data-v-460c0dbf><div class="shrink-0 h-10 w-10 rounded overflow-hidden bg-gray-200 dark:bg-gray-700" data-v-460c0dbf>`);
          if (isImage(file.mimeType)) {
            _push(`<img${ssrRenderAttr("src", file.url)}${ssrRenderAttr("alt", file.filename)} class="h-full w-full object-cover" data-v-460c0dbf>`);
          } else {
            _push(`<div class="h-full w-full flex items-center justify-center" data-v-460c0dbf><svg class="h-6 w-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" data-v-460c0dbf><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd" data-v-460c0dbf></path></svg></div>`);
          }
          _push(`</div><div class="flex-1 min-w-0" data-v-460c0dbf><p class="text-sm font-medium text-black dark:text-white truncate" data-v-460c0dbf>${ssrInterpolate(file.filename)}</p><p class="text-xs text-gray-500 dark:text-gray-400" data-v-460c0dbf>${ssrInterpolate(unref(formatFileSize)(file.sizeBytes))}</p></div><button type="button" class="shrink-0 p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors" title="Удалить" data-v-460c0dbf><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-460c0dbf><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-460c0dbf></path></svg></button></div>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
...
const FileUploader = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$9, [["__scopeId", "data-v-460c0dbf"]]), { __name: "CommonFileUploader" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.isOpen) {
          _push2(`<div class="fixed inset-0 flex items-center justify-center overflow-y-auto z-99999 p-4" data-v-c69c090c><div class="fixed inset-0 bg-black/80 backdrop-blur-sm transition-opacity" aria-hidden="true" data-v-c69c090c></div><div class="relative bg-white dark:bg-boxdark rounded-lg shadow-xl w-full max-w-4xl transition-all" role="dialog" aria-modal="true" data-v-c69c090c><div class="flex items-center justify-between px-6 py-4 border-b border-stroke dark:border-strokedark" data-v-c69c090c><h3 class="text-xl font-semibold text-black dark:text-white truncate" data-v-c69c090c>${ssrInterpolate(__props.file?.filename || "Просмотр файла")}</h3><button type="button" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors" data-v-c69c090c><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c69c090c><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-c69c090c></path></svg></button></div><div class="p-6" data-v-c69c090c>`);
          if (isImage.value) {
            _push2(`<div class="flex items-center justify-center bg-gray-50 dark:bg-gray-900 rounded-lg p-4" data-v-c69c090c><img${ssrRenderAttr("src", __props.file.url)}${ssrRenderAttr("alt", __props.file.filename)} class="max-w-full max-h-[60vh] object-contain rounded" data-v-c69c090c></div>`);
          } else if (isVideo.value) {
            _push2(`<div class="flex items-center justify-center bg-gray-50 dark:bg-gray-900 rounded-lg p-4" data-v-c69c090c><video${ssrRenderAttr("src", __props.file.url)} controls class="max-w-full max-h-[60vh] rounded" data-v-c69c090c> Ваш браузер не поддерживает видео. </video></div>`);
          } else if (isAudio.value) {
            _push2(`<div class="flex items-center justify-center bg-gray-50 dark:bg-gray-900 rounded-lg p-8" data-v-c69c090c><audio${ssrRenderAttr("src", __props.file.url)} controls class="w-full" data-v-c69c090c> Ваш браузер не поддерживает аудио. </audio></div>`);
          } else {
            _push2(`<div class="text-center py-12" data-v-c69c090c>`);
            ...
            _push2(`<p class="text-lg font-medium text-black dark:text-white mb-2" data-v-c69c090c>${ssrInterpolate(__props.file.filename)}</p><p class="text-sm text-gray-500 dark:text-gray-400" data-v-c69c090c> Предпросмотр недоступен для этого типа файлов </p></div>`);
          }
          _push2(`<div class="mt-6 grid grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg" data-v-c69c090c><div data-v-c69c090c><p class="text-xs text-gray-500 dark:text-gray-400 mb-1" data-v-c69c090c>Размер</p><p class="text-sm font-medium text-black dark:text-white" data-v-c69c090c>${ssrInterpolate(unref(formatFileSize)(__props.file.sizeBytes))}</p></div><div data-v-c69c090c><p class="text-xs text-gray-500 dark:text-gray-400 mb-1" data-v-c69c090c>Тип</p><p class="text-sm font-medium text-black dark:text-white" data-v-c69c090c>${ssrInterpolate(__props.file.extension.toUpperCase())}</p></div><div data-v-c69c090c><p class="text-xs text-gray-500 dark:text-gray-400 mb-1" data-v-c69c090c>Категория</p><p class="text-sm font-medium text-black dark:text-white" data-v-c69c090c>${ssrInterpolate(getCategoryLabel(__props.file.category))}</p></div><div data-v-c69c090c><p class="text-xs text-gray-500 dark:text-gray-400 mb-1" data-v-c69c090c>Дата загрузки</p><p class="text-sm font-medium text-black dark:text-white" data-v-c69c090c>${ssrInterpolate(formatDate(__props.file.createdAt))}</p></div></div></div><div class="px-6 py-4 border-t border-stroke dark:border-strokedark flex justify-end gap-3" data-v-c69c090c><a${ssrRenderAttr("href", __props.file.url)} download class="inline-flex items-center gap-2 rounded-md bg-gray-100 dark:bg-gray-800 px-4 py-2 text-sm font-medium text-black dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" data-v-c69c090c><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c69c090c><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" data-v-c69c090c></path></svg> Скачать </a><a${ssrRenderAttr("href", __props.file.url)} target="_blank" class="inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-opacity-90 transition-colors" data-v-c69c090c><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c69c090c><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" data-v-c69c090c></path></svg> Открыть в новой вкладке </a></div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const FilePreviewModal = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-c69c090c"]]), { __name: "FilesFilePreviewModal" });
...
//# sourceMappingURL=index-67M29JNd.mjs.map
