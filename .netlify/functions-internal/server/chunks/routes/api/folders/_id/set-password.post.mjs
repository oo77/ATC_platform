import { d as defineEventHandler, c as createError, b as getRouterParam, r as readBody, e as executeQuery } from '../../../../_/nitro.mjs';
...
const setPassword_post = defineEventHandler(async (event) => {
  try {
    ...
    await executeQuery(
      ...
      [passwordHash, /* @__PURE__ */ new Date(), folderId]
    );
    return {
      success: true,
...
export { setPassword_post as default };
//# sourceMappingURL=set-password.post.mjs.map
