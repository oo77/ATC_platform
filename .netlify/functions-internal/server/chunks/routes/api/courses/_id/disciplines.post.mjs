...
import { e as addDisciplineToCourse } from '../../../../_/courseRepository.mjs';
...
const disciplines_post = defineEventHandler(async (event) => {
  try {
...
export { disciplines_post as default };
//# sourceMappingURL=disciplines.post.mjs.map
