...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "3963ed85-1e1d-4e14-9e0c-651eeba3a03d",
...
const description$i = "\u041A\u043E\u043D\u0441\u043E\u043B\u0438\u0434\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u0430\u044F \u043C\u0438\u0433\u0440\u0430\u0446\u0438\u044F: \u043F\u043E\u043B\u043D\u0430\u044F \u0441\u0445\u0435\u043C\u0430 \u0431\u0430\u0437\u044B \u0434\u0430\u043D\u043D\u044B\u0445";
const up$m = async (connection) => {
  ...
  console.log(
    "\u{1F4CA} Created 20 tables with all indexes, constraints, and seed data"
  );
};
const down$m = async (connection) => {
...
const description$h = "\u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u0442\u0430\u0431\u043B\u0438\u0446 \u0434\u043B\u044F \u0441\u0438\u0441\u0442\u0435\u043C\u044B \u043F\u043E\u0441\u0435\u0449\u0430\u0435\u043C\u043E\u0441\u0442\u0438 \u0438 \u043E\u0446\u0435\u043D\u043E\u043A";
async function up$l(connection) {
...
async function down$l(connection) {
...
const description$g = "\u0420\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u0438\u0435 \u0448\u0430\u0431\u043B\u043E\u043D\u043E\u0432 \u0441\u0435\u0440\u0442\u0438\u0444\u0438\u043A\u0430\u0442\u043E\u0432 \u0438 \u0442\u0430\u0431\u043B\u0438\u0446\u0430 \u0432\u044B\u0434\u0430\u043D\u043D\u044B\u0445 \u0441\u0435\u0440\u0442\u0438\u0444\u0438\u043A\u0430\u0442\u043E\u0432";

const up$j = async (connection) => {
...
const description$f = "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u043F\u043E\u043B\u0435\u0439 \u0434\u043B\u044F \u0432\u0438\u0437\u0443\u0430\u043B\u044C\u043D\u043E\u0433\u043E \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440\u0430 \u0441\u0435\u0440\u0442\u0438\u0444\u0438\u043A\u0430\u0442\u043E\u0432 (template_data, layout, background_url)";

const description$e = "\u0421\u0440\u043E\u043A \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044F \u0441\u0435\u0440\u0442\u0438\u0444\u0438\u043A\u0430\u0442\u043E\u0432 \u0438 \u0440\u0430\u0437\u0440\u0435\u0448\u0435\u043D\u0438\u044F \u043F\u0440\u0435\u0434\u0441\u0442\u0430\u0432\u0438\u0442\u0435\u043B\u0435\u0439";
...
const description$d = "\u0416\u0443\u0440\u043D\u0430\u043B \u0437\u0430\u043F\u0440\u043E\u0441\u043E\u0432 \u043F\u0440\u0435\u0434\u0441\u0442\u0430\u0432\u0438\u0442\u0435\u043B\u0435\u0439 \u0432 Telegram-\u0431\u043E\u0442\u0435";
...
const description$c = "\u041E\u0431\u044A\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u0435 \u0442\u0430\u0431\u043B\u0438\u0446 certificates \u0438 issued_certificates \u0432 \u0435\u0434\u0438\u043D\u0443\u044E \u0441\u0438\u0441\u0442\u0435\u043C\u0443";

const description$b = "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 user_id \u0432 \u0442\u0430\u0431\u043B\u0438\u0446\u044B students \u0438 instructors \u0434\u043B\u044F \u0441\u0438\u0441\u0442\u0435\u043C\u044B \u0440\u0430\u0437\u0440\u0435\u0448\u0435\u043D\u0438\u0439";
async function up$f() {
...
const description$a = "Expand activity_logs ENUM columns (action_type, entity_type)";
async function up$e() {
...
const description$9 = "\u0421\u0438\u0441\u0442\u0435\u043C\u0430 \u0442\u0435\u0441\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F \u0441\u0442\u0443\u0434\u0435\u043D\u0442\u043E\u0432: \u0431\u0430\u043D\u043A\u0438 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432, \u0448\u0430\u0431\u043B\u043E\u043D\u044B \u0442\u0435\u0441\u0442\u043E\u0432, \u043D\u0430\u0437\u043D\u0430\u0447\u0435\u043D\u0438\u044F, \u0441\u0435\u0441\u0441\u0438\u0438 \u043F\u0440\u043E\u0445\u043E\u0436\u0434\u0435\u043D\u0438\u044F \u0438 \u043E\u0442\u0432\u0435\u0442\u044B";

const name$2 = "Add preview mode support for test sessions";
async function up$c(connection) {
...
async function down$c(connection) {
  await connection.execute(`
...
async function up$b(connection) {
  await connection.execute(`
    ALTER TABLE test_sessions
...
async function down$b(connection) {
  await connection.execute(`
...
async function up$a(connection) {
...
async function down$a(connection) {
...
const description$8 = "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u043C\u043D\u043E\u0433\u043E\u044F\u0437\u044B\u0447\u043D\u043E\u0439 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0438: language \u0434\u043B\u044F \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432 \u0438 \u0441\u0435\u0441\u0441\u0438\u0439, allowed_languages \u0434\u043B\u044F \u0448\u0430\u0431\u043B\u043E\u043D\u043E\u0432";
async function up$9(connection) {
...
async function down$9(connection) {
...
const description$7 = "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u043F\u043E\u043B\u0435\u0439 \u0434\u043B\u044F \u043E\u0446\u0435\u043D\u043E\u043A \u0438\u0437 \u0442\u0435\u0441\u0442\u043E\u0432 \u0438 \u043E\u0442\u0441\u043B\u0435\u0436\u0438\u0432\u0430\u043D\u0438\u044F \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u0439";
async function up$8(connection) {
...
async function down$8(connection) {
...
const description$6 = "\u041F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0430 standalone \u0441\u0435\u0440\u0442\u0438\u0444\u0438\u043A\u0430\u0442\u043E\u0432 (\u0438\u043C\u043F\u043E\u0440\u0442 \u0438 \u0440\u0443\u0447\u043D\u043E\u0435 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435)";

const up$6 = async (connection) => {
  console.log("\u{1F504} Running migration: 20260108_035_student_portal_tables");
  await connection.query(`
...
const down$6 = async (connection) => {
  console.log("\u{1F504} Rolling back migration: 20260108_035_student_portal_tables");
...
const description$5 = "Student notifications table";
const up$5 = async (connection) => {
  console.log("\u{1F504} Running migration: 20260108_036_student_notifications");
  await connection.query(`
...
const down$5 = async (connection) => {
  console.log("\u{1F504} Rolling back migration: 20260108_036_student_notifications");
  await connection.query("DROP TABLE IF EXISTS student_notifications");
  console.log("  \u2705 Dropped table: student_notifications");
};

const description$4 = "Expand action_type ENUM with RESET_PASSWORD, APPROVE, REJECT, BLOCK, UNBLOCK, REVOKE, ISSUE, ASSIGN, UNASSIGN";
async function up$4() {
...
const description$3 = "\u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u0442\u0430\u0431\u043B\u0438\u0446 \u0434\u043B\u044F \u0441\u0438\u0441\u0442\u0435\u043C\u044B \u0434\u043E\u043F\u0443\u0441\u043A\u0430 \u043E\u0442\u043C\u0435\u0442\u043E\u043A \u043F\u043E\u0441\u0435\u0449\u0430\u0435\u043C\u043E\u0441\u0442\u0438 \u0438\u043D\u0441\u0442\u0440\u0443\u043A\u0442\u043E\u0440\u0430\u043C\u0438";
...
const description$2 = "\u0418\u0441\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0442\u0440\u0438\u0433\u0433\u0435\u0440\u0430 trg_schedule_event_after_insert";
...
const description$1 = "Backfill missing attendance marking statuses";
async function up$1(connection) {
  console.log("START: Backfilling attendance marking statuses...");
  const [settingsRows] = await connection.query("SELECT * FROM attendance_settings");
  const settings = {};
  ...
  for (const event of events) {
    ...
    const deadline = new Date(endTime.getTime() + deadlineHours * 60 * 60 * 1e3);
    const lateDeadline = new Date(endTime.getTime() + lateDeadlineHours * 60 * 60 * 1e3);
    let status = "pending";
    ...
    values.push(
      ...
      event.id,
      status,
      status === "on_time" ? null : null,
      // marked_by unknown for history
      deadline,
      lateDeadline,
      studentsCount,
      markedCount
...
const up = async (connection) => {
  console.log("\u{1F504} Running migration: 20260113_041_retake_system");
  await connection.query(`
...
const down = async (connection) => {
  console.log("\u{1F504} Rolling back migration: 20260113_041_retake_system");
  await connection.query(`
        ALTER TABLE test_assignments 
...
const description = "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0438 \u043F\u0435\u0440\u0435\u0441\u0434\u0430\u0447 (allowed_student_ids)";
...
async function consolidateMigrationRecords(connection) {
  ...
  await connection.query(
    ...
    ["20251224_001_consolidated_schema", description$i]
  );
...
const _lazy_aWaBOq = () => import('../routes/api/index.post2.mjs');
...
const _lazy_qAzvm6 = () => import('../routes/api/index.post3.mjs');
...
const _lazy_p0J7NH = () => import('../routes/api/index.post4.mjs');
...
const _lazy_YepCVu = () => import('../routes/api/index.post5.mjs');
const _lazy_ZvA5PR = () => import('../routes/api/index.post6.mjs');
...
const _lazy_c4WdHM = () => import('../routes/api/groups/_id/index.post.mjs');
...
const _lazy_VmNAb3 = () => import('../routes/api/index.post7.mjs');
...
const _lazy_uYc0IA = () => import('../routes/api/index.post8.mjs');
...
const _lazy_Ujz97K = () => import('../routes/api/index.post9.mjs');
...
const _lazy_nmBN59 = () => import('../routes/api/index.post10.mjs');
...
const _lazy_Qvq2Mv = () => import('../routes/api/index.post11.mjs');
const _lazy_2BhJV3 = () => import('../routes/api/students/my-courses/_id_.get.mjs');
const _lazy_aTNDa8 = () => import('../routes/api/students/index.get.mjs');
...
const _lazy_DL58eV = () => import('../routes/api/index.post12.mjs');
...
const handlers = [
  ...
  { route: '/api/students/my-courses', handler: _lazy_aTNDa8, lazy: true, middleware: false, method: "get" },
...
export { useRuntimeConfig as $, updateStudentsCount as A, runMigrations as B, getOrganizationById as C, deleteOrganization as D, organizationCodeExists as E, updateOrganization as F, getOrganizationsPaginated as G, createOrganization as H, searchOrganizations as I, getAllOrganizations as J, getOrganizationsStats as K, getRepresentativeById as L, deleteRepresentative as M, updateRepresentative as N, approveRepresentative as O, sendMessage as P, BOT_MESSAGES as Q, blockRepresentative as R, getRepresentativesPaginated as S, getPendingRepresentatives as T, UserRole as U, getRepresentativeStats as V, getBot as W, verifyWebhookSecret as X, handleUpdate as Y, getHeaders as Z, joinRelativeURL as _, getQuery as a, getResponseStatusText as a0, getResponseStatus as a1, defineRenderHandler as a2, destr as a3, getRouteRules as a4, withQuery as a5, klona as a6, hasProtocol as a7, isScriptProtocol as a8, joinURL as a9, parse as aa, getRequestHeader as ab, isEqual as ac, sanitizeStatusCode as ad, getContext as ae, setCookie as af, getCookie as ag, deleteCookie as ah, $fetch as ai, createHooks as aj, executeAsync as ak, toRouteMatcher as al, createRouter$1 as am, defu as an, parseQuery as ao, withTrailingSlash as ap, withoutTrailingSlash as aq, db as ar, auth as as, getRouterParam as b, createError$1 as c, defineEventHandler as d, executeQuery as e, createTokenPayload as f, getRouteRulesForPath as g, generateToken as h, generateRefreshToken as i, joinHeaders as j, toPublicUser as k, verifyRefreshToken as l, hashPassword as m, normalizeCookieHeader as n, getHeader as o, extractToken as p, verifyToken as q, readBody as r, setHeader as s, testConnection as t, useNitroApp as u, verifyPassword as v, readMultipartFormData as w, executeTransaction as x, getRequestIP as y, getOrCreateOrganizationByName as z };
