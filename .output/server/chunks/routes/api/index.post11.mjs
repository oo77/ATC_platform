import { g as defineEventHandler, r as readBody, h as createError, f as executeQuery, J as invalidateRelatedCache } from '../../_/nitro.mjs';
import { e as checkScheduleConflicts, i as createScheduleEvent } from '../../_/scheduleRepository.mjs';
...
import { f as formatDateOnly, a as formatDateForDisplay, b as dateToLocalIso } from '../../_/timeUtils.mjs';
import 'grammy';
import 'uuid';
import 'node:http';
import 'node:https';
...
const index_post = defineEventHandler(async (event) => {
  try {
    ...
    if (body.academicHours) {
      calculatedHours = body.academicHours;
    } else {
    ...
    if (body.eventType === "assessment" && body.testTemplateId && body.groupId) {
      try {
