import { g as defineEventHandler, h as createError, j as getRouterParam, r as readBody } from '../../../../../_/nitro.mjs';
...
const preview_post = defineEventHandler(async (event) => {
  try {
    ...
    if (allQuestions.length === 0) {
      throw createError({
        statusCode: 400,
        message: selectedLanguage ? `\u0412 \u0431\u0430\u043D\u043A\u0435 \u043D\u0435\u0442 \u0430\u043A\u0442\u0438\u0432\u043D\u044B\u0445 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432 \u043D\u0430 \u044F\u0437\u044B\u043A\u0435: ${selectedLanguage}` : "\u0412 \u0431\u0430\u043D\u043A\u0435 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432 \u043D\u0435\u0442 \u0430\u043A\u0442\u0438\u0432\u043D\u044B\u0445 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432"
      });
    }
