import { g as defineEventHandler, i as getQuery, h as createError, U as UserRole } from '../../_/nitro.mjs';
import { f as getGroups, h as getGroupsStats } from '../../_/groupRepository.mjs';
import { b as getPermissionContext, c as roleHasPermission, P as Permission, d as getTeacherGroups } from '../../_/permissions.mjs';
...
const index_get = defineEventHandler(async (event) => {
  try {
    ...
    const canViewAll = roleHasPermission(
      context.role,
      Permission.GROUPS_VIEW_ALL
    );
    const canViewOwn = roleHasPermission(
      context.role,
    ...
    if (context.role === UserRole.TEACHER && !canViewAll) {
      if (context.instructorId) {
        ...
        console.log(
          `[API Groups] TEACHER ${context.userId} \u0444\u0438\u043B\u044C\u0442\u0440\u0430\u0446\u0438\u044F \u043F\u043E \u0441\u0432\u043E\u0438\u043C \u0433\u0440\u0443\u043F\u043F\u0430\u043C: ${teacherGroupIds.length} \u0433\u0440\u0443\u043F\u043F`
        );
      } else {
        console.warn(
          `[API Groups] TEACHER ${context.userId} \u043D\u0435 \u0438\u043C\u0435\u0435\u0442 \u0441\u0432\u044F\u0437\u0430\u043D\u043D\u043E\u0433\u043E instructorId`
        );
        return {
          success: true,
          groups: [],
    ...
    await logActivity(event, "VIEW", "GROUP", void 0, void 0, {
