...
const _groupId__get = defineEventHandler(async (event) => {
  try {
    ...
    journalRows.sort(
      (a, b) => a.student.fullName.localeCompare(b.student.fullName, "ru")
    );
    console.log(
      `[GET /api/certificates/issue/${groupId}] \u0417\u0430\u0433\u0440\u0443\u0436\u0435\u043D \u0436\u0443\u0440\u043D\u0430\u043B: ${journalRows.length} \u0437\u0430\u043F\u0438\u0441\u0435\u0439, \u0448\u0430\u0431\u043B\u043E\u043D: ${template?.name || "\u043D\u0435 \u043D\u0430\u0437\u043D\u0430\u0447\u0435\u043D"}`
    );
    return {
      success: true,
      group: {
