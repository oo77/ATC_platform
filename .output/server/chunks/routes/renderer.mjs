...
import { af as joinRelativeURL, u as useRuntimeConfig, ag as getResponseStatusText, ah as getResponseStatus, ai as defineRenderHandler, aj as getQuery, ak as createError, d as destr, al as getRouteRules, c as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Платформа управления учебно-тренировочным центром АТЦ"}],"link":[{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png"},{"rel":"manifest","href":"/site.webmanifest"}],"style":[],"script":[],"noscript":[],"title":"АТЦ - Учебный центр"};
