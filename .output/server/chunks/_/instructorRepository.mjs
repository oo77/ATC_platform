...
import { v4 } from 'uuid';
import { g as getAcademicHourMinutes } from './academicHours.mjs';
...
function mapRowToInstructor(row) {
  return {
    ...
    usedHours: row.used_hours !== void 0 ? Number(row.used_hours) : void 0,
...
async function linkInstructorToUser(instructorId, userId) {
  await executeQuery("UPDATE instructors SET user_id = ? WHERE id = ?", [
    userId,
    instructorId
  ]);
}
...
async function getInstructorHoursStats(instructorId) {
  ...
  console.log(
    "[InstructorHours] \u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u0441\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0438 \u0434\u043B\u044F \u0438\u043D\u0441\u0442\u0440\u0443\u043A\u0442\u043E\u0440\u0430:",
    instructorId
  );
  const academicHourMinutes = await getAcademicHourMinutes();
  console.log(
  ...
  console.log(
    "[InstructorHours] \u041E\u0442\u0440\u0430\u0431\u043E\u0442\u0430\u043D\u043D\u044B\u0445 \u0437\u0430\u043D\u044F\u0442\u0438\u0439:",
    totalUsedRows[0]?.event_count || 0
  );
  console.log(
    "[InstructorHours] \u041E\u0442\u0440\u0430\u0431\u043E\u0442\u0430\u043D\u043D\u044B\u0445 \u0447\u0430\u0441\u043E\u0432:",
    totalUsedRows[0]?.total_hours || 0
  );
  ...
  console.log(
    "[InstructorHours] \u0417\u0430\u043F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u044B\u0445 \u0437\u0430\u043D\u044F\u0442\u0438\u0439:",
    totalScheduledRows[0]?.event_count || 0
  );
  console.log(
    "[InstructorHours] \u0417\u0430\u043F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u044B\u0445 \u0447\u0430\u0441\u043E\u0432:",
    totalScheduledRows[0]?.total_hours || 0
  );
  ...
  console.log(
    "[InstructorHours] \u0412\u0441\u0435\u0433\u043E \u0437\u0430\u043D\u044F\u0442\u0438\u0439:",
    totalAllRows[0]?.event_count || 0
  );
  const monthNames = [
    "\u042F\u043D\u0432\u0430\u0440\u044C",
    "\u0424\u0435\u0432\u0440\u0430\u043B\u044C",
  ...
  for (const row of usedByMonthRows) {
    ...
    existing.usedHours = Number(row.total_hours);
  ...
  for (const row of scheduledByMonthRows) {
    ...
    existing.scheduledHours = Number(row.total_hours);
  ...
  const byMonth = sortedMonths.map(([yearMonth, data]) => {
    ...
    return {
      ...
      usedHours: Math.round(data.usedHours * 10) / 10,
      scheduledHours: Math.round(data.scheduledHours * 10) / 10,
      eventCount: data.usedEvents + data.scheduledEvents
    };
  });
  const totalUsedHours = Number(totalUsedRows[0]?.total_hours || 0);
  const totalScheduledHours = Number(totalScheduledRows[0]?.total_hours || 0);
...
async function checkInstructorHoursLimit(instructorId, additionalHours) {
  ...
  const requestedHours = additionalHours;
...
export { getInstructorById as a, getInstructorHoursStats as b, checkInstructorHoursLimit as c, deleteInstructor as d, getAllInstructors as e, getInstructorsPaginated as f, getInstructorByUserId as g, createInstructor as h, instructorEmailExists as i, linkInstructorToUser as l, updateInstructor as u };
