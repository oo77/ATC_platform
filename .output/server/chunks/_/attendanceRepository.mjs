import { k as executeTransaction, f as executeQuery } from './nitro.mjs';
import { v4 } from 'uuid';
...
async function getJournalData(groupId, disciplineId) {
  ...
  const events = await executeQuery(eventsSql, [
    groupId,
    disciplineId
  ]);
...
function calculateAcademicHours(startTime, endTime, academicHourMinutes = 40) {
