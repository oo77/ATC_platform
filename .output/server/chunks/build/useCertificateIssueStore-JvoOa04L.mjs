...
const useCertificateIssueStore = () => {
  ...
  const currentStudentName = useState(
  ...
  const startBulkIssue = async (job) => {
    ...
    for (let i = 0; i < studentData.length; i++) {
      ...
      try {
        const response = await authFetch(`/api/certificates/issue/${job.groupId}`, {
          method: "POST",
          body: {
...
//# sourceMappingURL=useCertificateIssueStore-JvoOa04L.mjs.map
