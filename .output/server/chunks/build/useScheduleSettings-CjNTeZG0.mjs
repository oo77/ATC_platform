...
const DEFAULT_SETTINGS = {
  ...
  // Длительность академического часа для расчета учебных часов
...
const useScheduleSettings = () => {
  ...
  const periods = useState("schedule-periods", () => [
    ...DEFAULT_PERIODS
  ]);
...
//# sourceMappingURL=useScheduleSettings-CjNTeZG0.mjs.map
