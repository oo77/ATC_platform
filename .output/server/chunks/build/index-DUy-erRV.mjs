  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div><div class="hidden md:block overflow-x-auto"><table class="w-full"><thead><tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800"><th class="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Шаблон теста </th><th class="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Банк вопросов </th><th class="px-6 py-4 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Параметры </th><th class="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Языки </th><th class="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Статус </th><th class="px-6 py-4 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Действия </th></tr></thead><tbody class="divide-y divide-gray-200 dark:divide-gray-700"><!--[-->`);
        ssrRenderList(templates.value, (template) => {
          _push(`<tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"><td class="px-6 py-4"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10 shrink-0"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div><div class="min-w-0"><div class="font-medium text-gray-900 dark:text-white">${ssrInterpolate(template.name)}</div><div class="flex items-center gap-2 mt-1"><span class="inline-flex items-center rounded-full bg-gray-100 dark:bg-gray-700 px-2 py-0.5 text-xs font-medium text-gray-800 dark:text-gray-200">${ssrInterpolate(template.code)}</span>`);
          if (template.description) {
            _push(`<span class="text-sm text-gray-500 dark:text-gray-400 line-clamp-1">${ssrInterpolate(template.description)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div></div></td><td class="px-6 py-4">`);
          _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          _push(`</td><td class="px-6 py-4"><div class="flex flex-col gap-1 text-xs text-gray-600 dark:text-gray-400"><div class="flex items-center justify-center gap-1"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><span>${ssrInterpolate(getQuestionsLabel(template))}</span></div><div class="flex items-center justify-center gap-1"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><span>${ssrInterpolate(template.time_limit_minutes ? `${template.time_limit_minutes} мин` : "Без лимита")}</span></div><div class="flex items-center justify-center gap-1"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><span>${ssrInterpolate(template.passing_score)}%</span></div><div class="flex items-center justify-center gap-1"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg><span>${ssrInterpolate(template.max_attempts === 1 ? "1 попытка" : `${template.max_attempts} попыток`)}</span></div></div></td><td class="px-6 py-4">`);
          ...
          _push(`</td><td class="px-6 py-4"><span class="${ssrRenderClass([
        ...
        ssrRenderList(templates.value, (template) => {
          _push(`<div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"><div class="flex items-start justify-between mb-3"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div><div><div class="font-medium text-gray-900 dark:text-white">${ssrInterpolate(template.name)}</div><span class="inline-flex items-center rounded-full bg-gray-100 dark:bg-gray-700 px-2 py-0.5 text-xs font-medium text-gray-800 dark:text-gray-200">${ssrInterpolate(template.code)}</span></div></div><span class="${ssrRenderClass([
            "inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium",
            template.is_active ? "bg-success/10 text-success" : "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400"
          ])}">${ssrInterpolate(template.is_active ? "Активен" : "Неактивен")}</span></div>`);
          if (template.description) {
            _push(`<div class="text-sm text-gray-600 dark:text-gray-400 mb-3 line-clamp-2">${ssrInterpolate(template.description)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="text-sm text-gray-500 dark:text-gray-400 mb-3"> Банк: `);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/test-bank/${template.bank_id}`,
          ...
          _push(`</div><div class="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-3"><span class="flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> ${ssrInterpolate(getQuestionsLabel(template))}</span><span class="flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> ${ssrInterpolate(template.time_limit_minutes ? `${template.time_limit_minutes} мин` : "Без лимита")}</span></div><div class="flex items-center justify-between">`);
          if (template.allowed_languages && template.allowed_languages.length > 0) {
            _push(`<div class="flex items-center gap-1"><!--[-->`);
            ssrRenderList(template.allowed_languages, (lang) => {
              _push(`<span class="${ssrRenderClass(languageBadgeClasses[lang])}"${ssrRenderAttr("title", languageLabels[lang])}>${ssrInterpolate(languageFlags[lang])}</span>`);
      ...
      _push(ssrRenderComponent(_component_UiModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form${_scopeId}><div class="grid grid-cols-1 xl:grid-cols-3 gap-6"${_scopeId}><div class="space-y-4"${_scopeId}><h4 class="font-medium text-black dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2"${_scopeId}> Общая информация </h4><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Название <span class="text-danger"${_scopeId}>*</span></label><input${ssrRenderAttr("value", form.value.name)} type="text" placeholder="Например: Тест по охране труда" class="${ssrRenderClass([{ "border-danger": formErrors.value.name }, "w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary text-sm"])}"${_scopeId}>`);
            if (formErrors.value.name) {
              _push2(`<p class="mt-1 text-xs text-danger"${_scopeId}>${ssrInterpolate(formErrors.value.name)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-2 gap-3"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Код <span class="text-danger"${_scopeId}>*</span></label><input${ssrRenderAttr("value", form.value.code)} type="text" placeholder="CODE-01" class="${ssrRenderClass([{ "border-danger": formErrors.value.code }, "w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary uppercase text-sm"])}"${_scopeId}>`);
            if (formErrors.value.code) {
              _push2(`<p class="mt-1 text-xs text-danger"${_scopeId}>${ssrInterpolate(formErrors.value.code)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Банк <span class="text-danger"${_scopeId}>*</span></label><div class="relative"${_scopeId}><select class="${ssrRenderClass([{ "border-danger": formErrors.value.bank_id }, "w-full rounded-lg border border-stroke bg-transparent py-2 pl-3 pr-8 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none text-sm"])}"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(form.value.bank_id) ? ssrLooseContain(form.value.bank_id, "") : ssrLooseEqual(form.value.bank_id, "")) ? " selected" : ""}${_scopeId}>Выберите...</option><!--[-->`);
            ssrRenderList(banks.value, (bank) => {
              _push2(`<option${ssrRenderAttr("value", bank.id)}${ssrIncludeBooleanAttr(Array.isArray(form.value.bank_id) ? ssrLooseContain(form.value.bank_id, bank.id) : ssrLooseEqual(form.value.bank_id, bank.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(bank.name)}</option>`);
            });
            _push2(`<!--]--></select><svg class="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"${_scopeId}></path></svg></div>`);
            if (formErrors.value.bank_id) {
              _push2(`<p class="mt-1 text-xs text-danger"${_scopeId}>${ssrInterpolate(formErrors.value.bank_id)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Описание </label><textarea rows="3" class="w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary resize-none text-sm"${_scopeId}>${ssrInterpolate(form.value.description)}</textarea></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Языки <span class="text-danger"${_scopeId}>*</span></label><div class="flex flex-wrap gap-2"${_scopeId}><!--[-->`);
            ssrRenderList(availableLanguages, (lang) => {
              ...
              ], "flex items-center gap-2 cursor-pointer p-2 rounded-lg border transition-all"])}"${_scopeId}><input type="checkbox"${ssrRenderAttr("value", lang.value)}${ssrIncludeBooleanAttr(Array.isArray(form.value.allowed_languages) ? ssrLooseContain(form.value.allowed_languages, lang.value) : form.value.allowed_languages) ? " checked" : ""} class="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary"${_scopeId}><span${_scopeId}>${ssrInterpolate(lang.flag)}</span></label>`);
            });
            _push2(`<!--]--></div>`);
            if (formErrors.value.allowed_languages) {
              _push2(`<p class="mt-1 text-xs text-danger"${_scopeId}>${ssrInterpolate(formErrors.value.allowed_languages)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (form.value.bank_id && form.value.allowed_languages.length > 0 && form.value.questions_mode === "random") {
              _push2(`<div class="mt-2 space-y-1"${_scopeId}>`);
              if (languageValidationLoading.value) {
                _push2(`<div class="text-xs text-gray-500"${_scopeId}> Проверка... </div>`);
              } else {
                ...
                ssrRenderList(languageValidation.value, (validation) => {
                  ...
                  ])}"${_scopeId}><div class="flex items-center gap-1"${_scopeId}><span${_scopeId}>${ssrInterpolate(validation.flag)}</span><span class="${ssrRenderClass(
                    validation.isValid ? "text-success" : "text-danger"
                  )}"${_scopeId}>${ssrInterpolate(validation.available)} / ${ssrInterpolate(validation.required)}</span></div></div>`);
                });
                _push2(`<!--]-->`);
                if (hasInvalidLanguages.value) {
                  _push2(`<p class="text-xs text-danger"${_scopeId}> Недостаточно вопросов </p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
            ...
            _push2(`</div></div><div class="space-y-4"${_scopeId}><h4 class="font-medium text-black dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2"${_scopeId}> Параметры теста </h4><div class="grid grid-cols-2 gap-3"${_scopeId}><div class="col-span-2"${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Режим выборки </label><select class="w-full rounded-lg border border-stroke bg-transparent py-2 pl-3 pr-8 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none text-sm"${_scopeId}><option value="all"${ssrIncludeBooleanAttr(Array.isArray(form.value.questions_mode) ? ssrLooseContain(form.value.questions_mode, "all") : ssrLooseEqual(form.value.questions_mode, "all")) ? " selected" : ""}${_scopeId}>Все вопросы</option><option value="random"${ssrIncludeBooleanAttr(Array.isArray(form.value.questions_mode) ? ssrLooseContain(form.value.questions_mode, "random") : ssrLooseEqual(form.value.questions_mode, "random")) ? " selected" : ""}${_scopeId}>Случайная выборка</option></select></div>`);
            if (form.value.questions_mode === "random") {
              _push2(`<div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Кол-во вопросов </label><input${ssrRenderAttr("value", form.value.questions_count)} type="number" min="1" class="w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary text-sm"${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="${ssrRenderClass({
              "col-span-2": form.value.questions_mode !== "random"
            })}"${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Пагинация </label><select class="w-full rounded-lg border border-stroke bg-transparent py-2 pl-3 pr-8 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none text-sm"${_scopeId}><option${ssrRenderAttr("value", 1)}${ssrIncludeBooleanAttr(Array.isArray(form.value.questions_per_page) ? ssrLooseContain(form.value.questions_per_page, 1) : ssrLooseEqual(form.value.questions_per_page, 1)) ? " selected" : ""}${_scopeId}>По 1 вопросу</option><option${ssrRenderAttr("value", 5)}${ssrIncludeBooleanAttr(Array.isArray(form.value.questions_per_page) ? ssrLooseContain(form.value.questions_per_page, 5) : ssrLooseEqual(form.value.questions_per_page, 5)) ? " selected" : ""}${_scopeId}>По 5 вопросов</option><option${ssrRenderAttr("value", 10)}${ssrIncludeBooleanAttr(Array.isArray(form.value.questions_per_page) ? ssrLooseContain(form.value.questions_per_page, 10) : ssrLooseEqual(form.value.questions_per_page, 10)) ? " selected" : ""}${_scopeId}>По 10 вопросов</option><option${ssrRenderAttr("value", 0)}${ssrIncludeBooleanAttr(Array.isArray(form.value.questions_per_page) ? ssrLooseContain(form.value.questions_per_page, 0) : ssrLooseEqual(form.value.questions_per_page, 0)) ? " selected" : ""}${_scopeId}>Все сразу</option></select></div></div><div class="space-y-2 pt-1"${_scopeId}><label class="flex items-center gap-2 cursor-pointer text-sm"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(form.value.shuffle_questions) ? ssrLooseContain(form.value.shuffle_questions, null) : form.value.shuffle_questions) ? " checked" : ""} type="checkbox" class="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary"${_scopeId}><span class="text-gray-700 dark:text-gray-300"${_scopeId}>Перемешивать вопросы</span></label><label class="flex items-center gap-2 cursor-pointer text-sm"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(form.value.shuffle_options) ? ssrLooseContain(form.value.shuffle_options, null) : form.value.shuffle_options) ? " checked" : ""} type="checkbox" class="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary"${_scopeId}><span class="text-gray-700 dark:text-gray-300"${_scopeId}>Перемешивать ответы</span></label><label class="flex items-center gap-2 cursor-pointer text-sm"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(form.value.allow_back) ? ssrLooseContain(form.value.allow_back, null) : form.value.allow_back) ? " checked" : ""} type="checkbox" class="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary"${_scopeId}><span class="text-gray-700 dark:text-gray-300"${_scopeId}>Разрешить возврат назад</span></label></div></div><div class="space-y-4"${_scopeId}><h4 class="font-medium text-black dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2"${_scopeId}> Ограничения и контроль </h4><div class="grid grid-cols-2 gap-3"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Время (мин) </label><input${ssrRenderAttr("value", form.value.time_limit_minutes)} type="number" min="0" placeholder="∞" class="w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary text-sm"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Попытки </label><input${ssrRenderAttr("value", form.value.max_attempts)} type="number" min="1" class="w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary text-sm"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Порог (%) </label><input${ssrRenderAttr("value", form.value.passing_score)} type="number" min="1" max="100" class="w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary text-sm"${_scopeId}></div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"${_scopeId}> Результаты </label><select class="w-full rounded-lg border border-stroke bg-transparent py-2 pl-3 pr-8 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none text-sm"${_scopeId}><option value="immediately"${ssrIncludeBooleanAttr(Array.isArray(form.value.show_results) ? ssrLooseContain(form.value.show_results, "immediately") : ssrLooseEqual(form.value.show_results, "immediately")) ? " selected" : ""}${_scopeId}>Сразу</option><option value="after_deadline"${ssrIncludeBooleanAttr(Array.isArray(form.value.show_results) ? ssrLooseContain(form.value.show_results, "after_deadline") : ssrLooseEqual(form.value.show_results, "after_deadline")) ? " selected" : ""}${_scopeId}>После дедлайна</option><option value="manual"${ssrIncludeBooleanAttr(Array.isArray(form.value.show_results) ? ssrLooseContain(form.value.show_results, "manual") : ssrLooseEqual(form.value.show_results, "manual")) ? " selected" : ""}${_scopeId}>Вручную</option><option value="never"${ssrIncludeBooleanAttr(Array.isArray(form.value.show_results) ? ssrLooseContain(form.value.show_results, "never") : ssrLooseEqual(form.value.show_results, "never")) ? " selected" : ""}${_scopeId}>Скрыть</option></select></div><div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3"${_scopeId}><div class="flex items-center justify-between mb-2"${_scopeId}><span class="text-sm font-medium text-gray-700 dark:text-gray-300"${_scopeId}>Антипрокторинг</span><label class="relative inline-flex items-center cursor-pointer"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(form.value.proctoring_enabled) ? ssrLooseContain(form.value.proctoring_enabled, null) : form.value.proctoring_enabled) ? " checked" : ""} type="checkbox" class="sr-only peer"${_scopeId}><div class="w-9 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[&#39;&#39;] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-danger"${_scopeId}></div></label></div>`);
            if (form.value.proctoring_enabled) {
              _push2(`<div class="space-y-1 pl-1 border-l-2 border-danger/20"${_scopeId}><label class="flex items-center gap-2 cursor-pointer text-xs"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(form.value.proctoring_settings.blockTabSwitch) ? ssrLooseContain(form.value.proctoring_settings.blockTabSwitch, null) : form.value.proctoring_settings.blockTabSwitch) ? " checked" : ""} type="checkbox" class="w-3.5 h-3.5 rounded border-gray-300 text-danger focus:ring-danger"${_scopeId}><span${_scopeId}>Блок вкладок</span></label><label class="flex items-center gap-2 cursor-pointer text-xs"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(form.value.proctoring_settings.blockCopyPaste) ? ssrLooseContain(form.value.proctoring_settings.blockCopyPaste, null) : form.value.proctoring_settings.blockCopyPaste) ? " checked" : ""} type="checkbox" class="w-3.5 h-3.5 rounded border-gray-300 text-danger focus:ring-danger"${_scopeId}><span${_scopeId}>Блок копирования</span></label></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="pt-2"${_scopeId}><label class="flex items-center gap-3 cursor-pointer p-2 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition"${_scopeId}><div class="relative inline-flex items-center"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(form.value.is_active) ? ssrLooseContain(form.value.is_active, null) : form.value.is_active) ? " checked" : ""} type="checkbox" class="sr-only peer"${_scopeId}><div class="w-9 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[&#39;&#39;] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-success"${_scopeId}></div></div><span class="text-sm font-medium"${_scopeId}>${ssrInterpolate(form.value.is_active ? "Шаблон активен" : "Черновик")}</span></label></div></div></div></form>`);
          } else {
            return [
              createVNode("form", {
                ...
                createVNode("div", { class: "grid grid-cols-1 xl:grid-cols-3 gap-6" }, [
                  createVNode("div", { class: "space-y-4" }, [
                    createVNode("h4", { class: "font-medium text-black dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2" }, " Общая информация "),
                    createVNode("div", null, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        class: ["w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary text-sm", { "border-danger": formErrors.value.name }]
                    ...
                    createVNode("div", { class: "grid grid-cols-2 gap-3" }, [
                      createVNode("div", null, [
                        ...
                        withDirectives(createVNode("input", {
                          ...
                          type: "text",
                          placeholder: "CODE-01",
                          class: ["w-full rounded-lg border border-stroke bg-transparent py-2 px-3 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary uppercase text-sm", { "border-danger": formErrors.value.code }]
                        }, null, 10, ["onUpdate:modelValue"]), [
                      ...
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, [
                          createTextVNode(" Банк "),
                          createVNode("span", { class: "text-danger" }, "*")
                        ]),
                        createVNode("div", { class: "relative" }, [
                          withDirectives(createVNode("select", {
                            "onUpdate:modelValue": ($event) => form.value.bank_id = $event,
                            class: ["w-full rounded-lg border border-stroke bg-transparent py-2 pl-3 pr-8 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none text-sm", { "border-danger": formErrors.value.bank_id }]
                          }, [
                            createVNode("option", { value: "" }, "Выберите..."),
                            (openBlock(true), createBlock(Fragment, null, renderList(banks.value, (bank) => {
                              return openBlock(), createBlock("option", {
                                key: bank.id,
                                value: bank.id
                              }, toDisplayString(bank.name), 9, ["value"]);
                            }), 128))
                    ...
                    createVNode("div", null, [
                      ...
                      createVNode("div", { class: "flex flex-wrap gap-2" }, [
                        (openBlock(), createBlock(Fragment, null, renderList(availableLanguages, (lang) => {
                          return createVNode("label", {
                            ...
                            createVNode("span", null, toDisplayString(lang.flag), 1)
                          ], 2);
                        }), 64))
                      ]),
                      ...
                      form.value.bank_id && form.value.allowed_languages.length > 0 && form.value.questions_mode === "random" ? (openBlock(), createBlock("div", {
                        ...
                        languageValidationLoading.value ? (openBlock(), createBlock("div", {
                        ...
                        }, " Проверка... ")) : (openBlock(), createBlock("div", {
                          key: 1,
                          class: "space-y-1"
                        }, [
                          ...
                          }, " Недостаточно вопросов ")) : createCommentVNode("", true)
                        ]))
                      ])) : createCommentVNode("", true)
                    ])
                  ]),
                  createVNode("div", { class: "space-y-4" }, [
                    createVNode("h4", { class: "font-medium text-black dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2" }, " Параметры теста "),
                    createVNode("div", { class: "grid grid-cols-2 gap-3" }, [
                      createVNode("div", { class: "col-span-2" }, [
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, " Режим выборки "),
                        withDirectives(createVNode("select", {
                          ...
                          createVNode("option", { value: "all" }, "Все вопросы"),
                          createVNode("option", { value: "random" }, "Случайная выборка")
                        ], 8, ["onUpdate:modelValue"]), [
                          [vModelSelect, form.value.questions_mode]
                        ])
                      ]),
                      form.value.questions_mode === "random" ? (openBlock(), createBlock("div", { key: 0 }, [
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, " Кол-во вопросов "),
                        withDirectives(createVNode("input", {
                      ...
                      createVNode("div", {
                        ...
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, " Пагинация "),
                        withDirectives(createVNode("select", {
                          "onUpdate:modelValue": ($event) => form.value.questions_per_page = $event,
                          class: "w-full rounded-lg border border-stroke bg-transparent py-2 pl-3 pr-8 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none text-sm"
                        }, [
                          createVNode("option", { value: 1 }, "По 1 вопросу"),
                          createVNode("option", { value: 5 }, "По 5 вопросов"),
                          createVNode("option", { value: 10 }, "По 10 вопросов"),
                    ...
                    createVNode("div", { class: "space-y-2 pt-1" }, [
                      createVNode("label", { class: "flex items-center gap-2 cursor-pointer text-sm" }, [
                        withDirectives(createVNode("input", {
                        ...
                        createVNode("span", { class: "text-gray-700 dark:text-gray-300" }, "Перемешивать вопросы")
                      ]),
                      createVNode("label", { class: "flex items-center gap-2 cursor-pointer text-sm" }, [
                        withDirectives(createVNode("input", {
                        ...
                        createVNode("span", { class: "text-gray-700 dark:text-gray-300" }, "Перемешивать ответы")
                      ]),
                      createVNode("label", { class: "flex items-center gap-2 cursor-pointer text-sm" }, [
                        withDirectives(createVNode("input", {
                        ...
                        createVNode("span", { class: "text-gray-700 dark:text-gray-300" }, "Разрешить возврат назад")
                      ])
                    ])
                  ]),
                  createVNode("div", { class: "space-y-4" }, [
                    createVNode("h4", { class: "font-medium text-black dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2" }, " Ограничения и контроль "),
                    createVNode("div", { class: "grid grid-cols-2 gap-3" }, [
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, " Время (мин) "),
                        withDirectives(createVNode("input", {
                      ...
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, " Попытки "),
                        withDirectives(createVNode("input", {
                      ...
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, " Порог (%) "),
                        withDirectives(createVNode("input", {
                    ...
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" }, " Результаты "),
                      withDirectives(createVNode("select", {
                        "onUpdate:modelValue": ($event) => form.value.show_results = $event,
                        class: "w-full rounded-lg border border-stroke bg-transparent py-2 pl-3 pr-8 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none text-sm"
                      }, [
                        createVNode("option", { value: "immediately" }, "Сразу"),
                        createVNode("option", { value: "after_deadline" }, "После дедлайна"),
                        createVNode("option", { value: "manual" }, "Вручную"),
                        createVNode("option", { value: "never" }, "Скрыть")
                      ], 8, ["onUpdate:modelValue"]), [
                        [vModelSelect, form.value.show_results]
                      ])
                    ]),
                    createVNode("div", { class: "bg-gray-50 dark:bg-gray-800 rounded-lg p-3" }, [
                      createVNode("div", { class: "flex items-center justify-between mb-2" }, [
                        createVNode("span", { class: "text-sm font-medium text-gray-700 dark:text-gray-300" }, "Антипрокторинг"),
                        createVNode("label", { class: "relative inline-flex items-center cursor-pointer" }, [
                          ...
                          createVNode("div", { class: "w-9 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-danger" })
                        ])
                      ]),
                      form.value.proctoring_enabled ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("label", { class: "flex items-center gap-2 cursor-pointer text-xs" }, [
                          withDirectives(createVNode("input", {
                          ...
                          createVNode("span", null, "Блок вкладок")
                        ]),
                        createVNode("label", { class: "flex items-center gap-2 cursor-pointer text-xs" }, [
                          withDirectives(createVNode("input", {
                          ...
                          createVNode("span", null, "Блок копирования")
                        ])
                      ])) : createCommentVNode("", true)
                    ]),
                    createVNode("div", { class: "pt-2" }, [
                      createVNode("label", { class: "flex items-center gap-3 cursor-pointer p-2 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition" }, [
                        createVNode("div", { class: "relative inline-flex items-center" }, [
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("span", { class: "text-sm font-medium" }, toDisplayString(form.value.is_active ? "Шаблон активен" : "Черновик"), 1)
                      ])
                    ])
                  ])
                ])
...
//# sourceMappingURL=index-DUy-erRV.mjs.map
