...
import { defineComponent, computed, ref, watch, mergeProps, unref, withCtx, createBlock, createTextVNode, openBlock, createVNode, toDisplayString, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
...
import { l as useRoute, u as useHead } from './server.mjs';
import { u as useAuthFetch } from './useAuthFetch-DSbqu-Nq.mjs';
import { u as useNotification } from './useNotification-B8oxL3PM.mjs';
import { u as useCertificateIssueStore } from './useCertificateIssueStore-JvoOa04L.mjs';
import '../_/nitro.mjs';
import 'grammy';
import 'uuid';
import 'node:http';
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.isOpen) {
          _push2(`<div class="fixed inset-0 z-9999 flex items-center justify-center" data-v-9464bcca><div class="absolute inset-0 bg-black/50 backdrop-blur-sm" data-v-9464bcca></div><div class="relative bg-white dark:bg-boxdark rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden" data-v-9464bcca><div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700" data-v-9464bcca><div class="flex items-center gap-3" data-v-9464bcca><div class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center" data-v-9464bcca><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-9464bcca><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" data-v-9464bcca></path></svg></div><div data-v-9464bcca><h3 class="text-lg font-semibold text-gray-900 dark:text-white" data-v-9464bcca>${ssrInterpolate(unref(isProcessing) ? "Выдача сертификатов" : "Подтверждение выдачи")}</h3><p class="text-sm text-gray-500 dark:text-gray-400" data-v-9464bcca>${ssrInterpolate(unref(isProcessing) ? "Пожалуйста, подождите..." : `${__props.studentsCount} слушателей`)}</p></div></div></div><div class="px-6 py-6" data-v-9464bcca>`);
          if (!unref(isProcessing) && !unref(isCompleted)) {
            _push2(`<!--[--><p class="text-gray-600 dark:text-gray-300 mb-4" data-v-9464bcca> Вы собираетесь выдать сертификаты <strong data-v-9464bcca>${ssrInterpolate(__props.studentsCount)}</strong> слушателям. </p><div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-4" data-v-9464bcca><div class="flex items-center gap-3" data-v-9464bcca><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-9464bcca><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-9464bcca></path></svg><div data-v-9464bcca><p class="text-sm font-medium text-gray-900 dark:text-white" data-v-9464bcca>${ssrInterpolate(__props.templateName)}</p><p class="text-xs text-gray-500" data-v-9464bcca>Шаблон сертификата</p></div></div></div><p class="text-sm text-gray-500 dark:text-gray-400" data-v-9464bcca> Продолжить выдачу? </p><!--]-->`);
          } else if (unref(isProcessing)) {
            _push2(`<div class="space-y-4" data-v-9464bcca><div data-v-9464bcca><div class="flex justify-between text-sm mb-2" data-v-9464bcca><span class="text-gray-600 dark:text-gray-400" data-v-9464bcca>Прогресс</span><span class="font-medium text-gray-900 dark:text-white" data-v-9464bcca>${ssrInterpolate(unref(processedCount))} / ${ssrInterpolate(__props.studentsCount)}</span></div><div class="relative w-full h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden" data-v-9464bcca><div class="absolute left-0 top-0 h-full bg-linear-to-r from-primary to-primary/80 rounded-full transition-all duration-300 ease-out" style="${ssrRenderStyle({ width: `${unref(progressPercent)}%` })}" data-v-9464bcca></div>`);
            if (unref(progressPercent) < 100) {
              _push2(`<div class="absolute right-0 top-0 h-full w-12 bg-linear-to-l from-primary/30 to-transparent animate-pulse" style="${ssrRenderStyle({ left: `${Math.max(0, unref(progressPercent) - 5)}%` })}" data-v-9464bcca></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg" data-v-9464bcca><div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center animate-pulse" data-v-9464bcca><svg class="w-4 h-4 text-primary animate-spin" fill="none" viewBox="0 0 24 24" data-v-9464bcca><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-9464bcca></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-9464bcca></path></svg></div><div class="min-w-0 flex-1" data-v-9464bcca><p class="text-sm font-medium text-gray-900 dark:text-white truncate" data-v-9464bcca>${ssrInterpolate(unref(currentStudentName) || "Обработка...")}</p><p class="text-xs text-gray-500" data-v-9464bcca>Создание сертификата...</p></div></div><div class="grid grid-cols-3 gap-3 text-center" data-v-9464bcca><div class="p-2 bg-success/10 rounded-lg" data-v-9464bcca><p class="text-lg font-bold text-success" data-v-9464bcca>${ssrInterpolate(unref(successCount))}</p><p class="text-xs text-success/80" data-v-9464bcca>Успешно</p></div><div class="p-2 bg-warning/10 rounded-lg" data-v-9464bcca><p class="text-lg font-bold text-warning" data-v-9464bcca>${ssrInterpolate(unref(warningCount))}</p><p class="text-xs text-warning/80" data-v-9464bcca>С замечаниями</p></div><div class="p-2 bg-danger/10 rounded-lg" data-v-9464bcca><p class="text-lg font-bold text-danger" data-v-9464bcca>${ssrInterpolate(unref(errorCount))}</p><p class="text-xs text-danger/80" data-v-9464bcca>Ошибки</p></div></div></div>`);
          } else if (unref(isCompleted)) {
            _push2(`<div class="text-center py-4" data-v-9464bcca><div class="mx-auto w-16 h-16 rounded-full bg-success/10 flex items-center justify-center mb-4" data-v-9464bcca><svg class="w-8 h-8 text-success" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-9464bcca><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" data-v-9464bcca></path></svg></div><h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2" data-v-9464bcca> Выдача завершена </h4><p class="text-gray-500 dark:text-gray-400 mb-4" data-v-9464bcca> Обработано ${ssrInterpolate(unref(processedCount))} из ${ssrInterpolate(__props.studentsCount)} слушателей </p><div class="grid grid-cols-3 gap-3 text-center mb-4" data-v-9464bcca><div class="p-3 bg-success/10 rounded-lg" data-v-9464bcca><p class="text-2xl font-bold text-success" data-v-9464bcca>${ssrInterpolate(unref(successCount))}</p><p class="text-xs text-success/80" data-v-9464bcca>Выдано</p></div><div class="p-3 bg-warning/10 rounded-lg" data-v-9464bcca><p class="text-2xl font-bold text-warning" data-v-9464bcca>${ssrInterpolate(unref(warningCount))}</p><p class="text-xs text-warning/80" data-v-9464bcca>С замечаниями</p></div><div class="p-3 bg-danger/10 rounded-lg" data-v-9464bcca><p class="text-2xl font-bold text-danger" data-v-9464bcca>${ssrInterpolate(unref(errorCount))}</p><p class="text-xs text-danger/80" data-v-9464bcca>Ошибки</p></div></div>`);
            if (unref(errors).length > 0) {
              _push2(`<div class="text-left max-h-32 overflow-y-auto" data-v-9464bcca><p class="text-sm font-medium text-danger mb-2" data-v-9464bcca>Ошибки:</p><ul class="text-sm text-gray-600 dark:text-gray-400 space-y-1" data-v-9464bcca><!--[-->`);
              ssrRenderList(unref(errors), (err, idx) => {
                _push2(`<li class="flex items-start gap-2" data-v-9464bcca><svg class="w-4 h-4 text-danger shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-9464bcca><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-9464bcca></path></svg><span data-v-9464bcca>${ssrInterpolate(err.studentName)}: ${ssrInterpolate(err.error)}</span></li>`);
              });
              _push2(`<!--]--></ul></div>`);
            } else {
              _push2(`<!---->`);
          ...
          _push2(`</div><div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3" data-v-9464bcca>`);
          if (!unref(isProcessing) && !unref(isCompleted)) {
            _push2(`<!--[-->`);
            _push2(ssrRenderComponent(_component_UiButton, {
              variant: "outline",
            ...
            _push2(ssrRenderComponent(_component_UiButton, {
              ...
              default: withCtx((_, _push3, _parent2, _scopeId) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-9464bcca${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" data-v-9464bcca${_scopeId}></path></svg> Выдать сертификаты `);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "w-4 h-4 mr-2",
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-9464bcca"]]), { __name: "CertificatesBulkIssueModal" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const loadData = async () => {
      loading.value = true;
      try {
        const journalRes = await authFetch(
        ...
        try {
          const instructorsRes = await authFetch(`/api/certificates/issue/${groupId.value}/instructors`);
    ...
    const openBulkIssueModal = (mode) => {
      ...
      if (mode === "eligible") {
        bulkIssueStudentIds.value = journal.value.filter(
          (r) => r.eligibility.isEligible && r.certificate?.status !== "issued"
        ).map((r) => r.student.id);
      } else {
    ...
    const executeBulkIssue = async () => {
      ...
      const job = {
        ...
        issueDate: issueDate.value ?? (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
    ...
    const handleBulkIssueComplete = async (_results) => {
      selectedStudentIds.value = [];
      await loadData();
    };
    watch(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        if (unref(instructors).length > 0) {
          _push(`<div class="flex items-center gap-2"><label class="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Инструктор:</label><select class="rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-gray-900 dark:text-white focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 min-w-[200px]"><option${ssrRenderAttr("value", null)}${ssrIncludeBooleanAttr(Array.isArray(unref(selectedInstructorId)) ? ssrLooseContain(unref(selectedInstructorId), null) : ssrLooseEqual(unref(selectedInstructorId), null)) ? " selected" : ""}>Не указан</option><!--[-->`);
          ssrRenderList(unref(instructors), (instructor) => {
            _push(`<option${ssrRenderAttr("value", instructor.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(selectedInstructorId)) ? ssrLooseContain(unref(selectedInstructorId), instructor.id) : ssrLooseEqual(unref(selectedInstructorId), instructor.id)) ? " selected" : ""}>${ssrInterpolate(instructor.fullName)} `);
        ...
        _push(ssrRenderComponent(_component_UiButton, {
          ...
          disabled: !unref(template) || unref(eligibleWithoutCertificate) === 0 || unref(isIssuing) || unref(certIssueStore).isIssuing.value,
          variant: "primary"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(ssrRenderComponent(_component_UiButton, {
          ...
          disabled: !unref(template) || unref(selectedStudentIds).length === 0 || unref(isIssuing) || unref(certIssueStore).isIssuing.value,
          variant: "outline"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(ssrRenderComponent(_component_UiButton, {
          ...
          disabled: unref(generatingPdf) || unref(journal).length === 0,
          variant: "secondary"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (!unref(generatingPdf)) {
                _push2(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"${_scopeId}></path></svg>`);
              } else {
              ...
              _push2(`<span${_scopeId}>${ssrInterpolate(unref(generatingPdf) ? "Генерация..." : "Ведомость")}</span><svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"${_scopeId}></path></svg>`);
            } else {
              return [
                !unref(generatingPdf) ? (openBlock(), createBlock("svg", {
                  key: 0,
                  class: "w-4 h-4 mr-2",
                  fill: "none",
                  stroke: "currentColor",
                ...
                createVNode("span", null, toDisplayString(unref(generatingPdf) ? "Генерация..." : "Ведомость"), 1),
                (openBlock(), createBlock("svg", {
                  class: "w-4 h-4 ml-1",
                  fill: "none",
                  stroke: "currentColor",
        ...
        _push(`</div></div>`);
        if (unref(certIssueStore).isIssuing.value && unref(certIssueStore).currentJob.value?.groupId === unref(groupId)) {
          _push(`<div class="mt-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800"><div class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center"><svg class="w-5 h-5 text-green-600 dark:text-green-400 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg></div><div class="flex-1"><p class="text-sm font-medium text-green-800 dark:text-green-200"> Выдача сертификатов в процессе... </p><div class="flex items-center gap-2 mt-1"><div class="flex-1 h-2 bg-green-200 dark:bg-green-700 rounded-full overflow-hidden"><div class="h-full bg-green-500 rounded-full transition-all duration-300" style="${ssrRenderStyle({ width: `${unref(certIssueStore).percentage.value}%` })}"></div></div><span class="text-xs text-green-600 dark:text-green-400">${ssrInterpolate(unref(certIssueStore).processedCount.value)}/${ssrInterpolate(unref(certIssueStore).totalCount.value)}</span></div><p class="text-xs text-green-600 dark:text-green-400 mt-1">${ssrInterpolate(unref(certIssueStore).currentStudentName.value || "Обработка...")}</p></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="rounded-xl bg-white dark:bg-boxdark shadow-md overflow-hidden"><div class="overflow-x-auto"><table class="w-full"><thead><tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800"><th class="px-4 py-3 text-left"><input type="checkbox"${ssrIncludeBooleanAttr(unref(isAllSelected)) ? " checked" : ""}${ssrRenderAttr("indeterminate", unref(isPartialSelected))} class="rounded border-gray-300 text-primary focus:ring-primary"></th><th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Слушатель </th><th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Посещаемость </th><th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Дисциплин </th><th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Ср. балл </th><th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Допуск </th><th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Сертификат </th><th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider"> Действия </th></tr></thead><tbody class="divide-y divide-gray-200 dark:divide-gray-700"><!--[-->`);
        ssrRenderList(unref(journal), (row) => {
          ...
          if (!row.certificate || row.certificate.status !== "issued") {
            _push(`<button${ssrIncludeBooleanAttr(
              !unref(template) || unref(isIssuing) || unref(issuingStudentId) === row.student.id
            ) ? " disabled" : ""} class="p-2 rounded-lg hover:bg-primary/10 text-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed" title="Выдать сертификат">`);
...
//# sourceMappingURL=certificates-DBhVXgmx.mjs.map
