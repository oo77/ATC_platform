...
import { _ as __nuxt_component_2 } from './GroupFormModal-brTMs9HC.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(groups), (group) => {
          ...
          _push(`</td><td class="px-6 py-4"><div class="text-sm"><div class="text-gray-900 dark:text-white">${ssrInterpolate(formatDate(group.startDate))}</div><div class="text-gray-500 dark:text-gray-400"> — ${ssrInterpolate(formatDate(group.endDate))}</div></div></td><td class="px-6 py-4"><span class="inline-flex items-center rounded-full bg-gray-100 dark:bg-gray-700 px-2.5 py-0.5 text-sm font-medium text-gray-800 dark:text-gray-200">${ssrInterpolate(group.studentCount || 0)}</span></td><td class="px-6 py-4"><span class="${ssrRenderClass([
...
//# sourceMappingURL=index-CtXp0MZt.mjs.map
