...
import { _ as __nuxt_component_0$2 } from './nuxt-link-DnWQlAEm.mjs';
...
import { e as useAuth, U as UserRole, a as useRouter$1 } from './server.mjs';
import { _ as __nuxt_component_2$3, a as __nuxt_component_3$2 } from './UserPasswordModal-DU7z1tfn.mjs';
import { _ as __nuxt_component_3$3 } from './ConfirmModal-D4ued3Bi.mjs';
import { _ as __nuxt_component_2$4 } from './InstructorFormModal-8D8lLyMB.mjs';
import { _ as __nuxt_component_1$5 } from './Pagination-BWEvmW2R.mjs';
import { _ as __nuxt_component_2$5, a as __nuxt_component_3$4 } from './StudentCertificatesModal-BG5Xd3Hu.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.users, (user) => {
        ...
        _push(ssrRenderComponent(_component_UiButton, {
          ...
          title: isCurrentUser(user.id) ? "Нельзя удалить самого себя" : "Удалить"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
const __nuxt_component_1$3 = Object.assign(_sfc_main$c, { __name: "UsersUserTable" });
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UsersUserFormModal = __nuxt_component_2$3;
      const _component_UsersUserPasswordModal = __nuxt_component_3$2;
      const _component_UiConfirmModal = __nuxt_component_3$3;
      ...
      _push(ssrRenderComponent(_component_UiConfirmModal, {
        ...
        "item-name": userToDelete.value?.name,
...
const __nuxt_component_0$1 = Object.assign(_sfc_main$b, { __name: "UsersUserManagementPanel" });
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overflow-x-auto" }, _attrs))}><table class="w-full table-auto"><thead><tr class="bg-gray-2 text-left dark:bg-meta-4"><th class="min-w-[220px] px-4 py-4 font-medium text-black dark:text-white xl:pl-11"> ФИО </th><th class="min-w-[150px] px-4 py-4 font-medium text-black dark:text-white"> Email </th><th class="min-w-[120px] px-4 py-4 font-medium text-black dark:text-white"> Телефон </th><th class="min-w-[120px] px-4 py-4 font-medium text-black dark:text-white"> Прием на работу </th><th class="min-w-[120px] px-4 py-4 font-medium text-black dark:text-white"> Часы (Отраб./Макс.) </th><th class="min-w-[100px] px-4 py-4 font-medium text-black dark:text-white"> Статус </th></tr></thead><tbody>`);
      if (__props.loading) {
...
const __nuxt_component_1$2 = Object.assign(_sfc_main$a, { __name: "UsersInstructorTable" });
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UsersInstructorFormModal = __nuxt_component_2$4;
...
const __nuxt_component_1$1 = Object.assign(_sfc_main$9, { __name: "UsersInstructorManagementPanel" });
...
const __nuxt_component_2$2 = Object.assign(_sfc_main$8, { __name: "DatabaseStudentTable" });
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleLimitChange = (limit2) => {
      pagination.value.limit = limit2;
...
Пароль: ${response.generatedPassword}`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_UiButton = __nuxt_component_1$4;
      const _component_DatabaseStudentTable = __nuxt_component_2$2;
      const _component_UiPagination = __nuxt_component_1$5;
      const _component_DatabaseStudentFormModal = __nuxt_component_2$5;
      const _component_DatabaseStudentCertificatesModal = __nuxt_component_3$4;
      const _component_UiConfirmModal = __nuxt_component_3$3;
...
const __nuxt_component_2$1 = Object.assign(_sfc_main$7, { __name: "DatabaseStudentManagementPanel" });
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["view", "approve", "block", "unblock", "delete"],
  setup(__props) {
        ...
        ssrRenderList(__props.representatives, (rep) => {
          ...
          if (rep.status === "blocked") {
            _push(ssrRenderComponent(_component_UiButton, {
              variant: "success",
              size: "sm",
              onClick: ($event) => _ctx.$emit("unblock", rep),
              title: "Разблокировать"
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"${_scopeId}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "w-4 h-4",
...
const __nuxt_component_0 = Object.assign(_sfc_main$6, { __name: "RepresentativesRepresentativeTable" });
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["close", "approve", "block", "unblock", "updated"],
        ...
        if (isVisible.value) {
          ...
          if (isVisible.value) {
            ...
            if (__props.representative.status === "blocked") {
              _push2(ssrRenderComponent(_component_UiButton, {
                variant: "success",
                onClick: ($event) => _ctx.$emit("unblock", __props.representative)
              }, {
                default: withCtx((_, _push3, _parent2, _scopeId) => {
                  if (_push3) {
...
const __nuxt_component_1 = Object.assign(_sfc_main$5, { __name: "RepresentativesRepresentativeDetailModal" });
...
const __nuxt_component_2 = Object.assign(_sfc_main$4, { __name: "RepresentativesApproveRepresentativeModal" });
...
const __nuxt_component_3$1 = Object.assign(_sfc_main$3, { __name: "RepresentativesBlockRepresentativeModal" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "UnblockRepresentativeModal",
  __ssrInlineRender: true,
  props: {
    representative: {},
    isOpen: { type: Boolean }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (isVisible.value) {
          _push2(`<div class="fixed inset-0 z-999999 flex items-center justify-center bg-black/80 px-4 py-5">`);
          if (isVisible.value) {
            _push2(`<div class="w-full max-w-lg rounded-lg bg-white dark:bg-boxdark shadow-xl"><div class="border-b border-stroke px-6 py-4 dark:border-strokedark flex items-center justify-between"><h3 class="text-xl font-semibold text-black dark:text-white"> Разблокировка представителя </h3><button class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div><div class="p-6"><div class="mb-6 rounded-lg bg-gray-50 dark:bg-meta-4 p-4"><div class="text-sm"><span class="text-gray-600 dark:text-gray-400">Представитель:</span><span class="ml-2 font-medium text-black dark:text-white">${ssrInterpolate(__props.representative.fullName)}</span></div><div class="text-sm mt-2"><span class="text-gray-600 dark:text-gray-400">Организация:</span><span class="ml-2 font-medium text-black dark:text-white">${ssrInterpolate(__props.representative.organizationName)}</span></div></div>`);
            if (__props.representative.blockedReason) {
              _push2(`<div class="mb-6"><p class="text-sm font-medium text-danger mb-1"> Причина блокировки: </p><p class="text-sm text-gray-700 dark:text-gray-300 bg-danger/5 p-3 rounded-md border border-danger/20">${ssrInterpolate(__props.representative.blockedReason)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="mb-6 rounded-lg bg-success/10 border border-success/20 p-4"><div class="flex gap-3"><svg class="w-5 h-5 text-success shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><div class="text-sm text-gray-700 dark:text-gray-300"><p class="font-medium mb-1">Подтверждение</p><p> После разблокировки представитель снова получит доступ к информации через Telegram-бота. Статус будет изменён на &quot;Одобрен&quot;. </p></div></div></div><div class="flex justify-end gap-4">`);
            _push2(ssrRenderComponent(_component_UiButton, {
              variant: "secondary",
              onClick: handleClose,
              disabled: isSubmitting.value
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/representatives/UnblockRepresentativeModal.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$2, { __name: "RepresentativesUnblockRepresentativeModal" });
const limit = 20;
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const representativeToUnblock = ref(null);
    const showDeleteModal = ref(false);
    const representativeToDelete = ref(null);
    ...
    const handleUnblock = (representative) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_RepresentativesUnblockRepresentativeModal = __nuxt_component_4;
      const _component_UiConfirmModal = __nuxt_component_3$3;
      ...
      if (representativeToUnblock.value) {
        _push(ssrRenderComponent(_component_RepresentativesUnblockRepresentativeModal, {
          representative: representativeToUnblock.value,
          "is-open": showUnblockModal.value,
      ...
      _push(ssrRenderComponent(_component_UiConfirmModal, {
        ...
        "item-name": representativeToDelete.value?.fullName,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DatabaseStudentManagementPanel = __nuxt_component_2$1;
...
//# sourceMappingURL=index-D24PZxqM.mjs.map
