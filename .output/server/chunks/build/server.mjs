import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, computed, readonly, ref, toRef, isRef, hasInjectionContext, inject, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, useSSRContext, createApp, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, nextTick, mergeProps, getCurrentScope } from 'vue';
import { d as destr, am as klona, an as hasProtocol, ao as isScriptProtocol, ap as joinURL, aq as withQuery, ar as parse, as as getRequestHeader, at as isEqual, au as sanitizeStatusCode, av as getContext, aw as setCookie, ax as getCookie, ay as deleteCookie, az as $fetch$1, aA as createHooks, aB as executeAsync, h as createError$1, aC as toRouteMatcher, aD as createRouter$1, aE as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "blank",
    path: "/blank",
    component: () => import('./blank-BnsIDBzU.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$G || {},
    component: () => import('./index-Bh36-vB6.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: __nuxt_page_meta$F || {},
    component: () => import('./profile-BeETKUsz.mjs')
  },
  {
    name: "support",
    path: "/support",
    meta: __nuxt_page_meta$E || {},
    component: () => import('./support-DhkJZdKL.mjs')
  },
  {
    name: "calendar",
    path: "/calendar",
    component: () => import('./calendar-wLONJpSi.mjs')
  },
  {
    name: "schedule",
    path: "/schedule",
    meta: __nuxt_page_meta$D || {},
    component: () => import('./schedule-Czh3u5-w.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    meta: __nuxt_page_meta$C || {},
    component: () => import('./settings-BMI609Df.mjs')
  },
  {
    name: "tests-my",
    path: "/tests/my",
    meta: __nuxt_page_meta$B || {},
    component: () => import('./my-DzhAZ30f.mjs')
  },
  {
    name: "error-404",
    path: "/error-404",
    component: () => import('./error-404-BVTEew_N.mjs')
  },
  {
    name: "docs",
    path: "/docs",
    meta: __nuxt_page_meta$A || {},
    component: () => import('./index-DQb4MUop.mjs')
  },
  {
    name: "users-id",
    path: "/users/:id()",
    meta: __nuxt_page_meta$z || {},
    component: () => import('./_id_-CM-2kYaE.mjs')
  },
  {
    name: "auth-signin",
    path: "/auth/signin",
    meta: __nuxt_page_meta$y || {},
    component: () => import('./signin-ZQicZwF_.mjs')
  },
  {
    name: "environment",
    path: "/environment",
    meta: __nuxt_page_meta$x || {},
    component: () => import('./environment-CwBIZ8jS.mjs')
  },
  {
    name: "files",
    path: "/files",
    meta: __nuxt_page_meta$w || {},
    component: () => import('./index-DGG09A-1.mjs')
  },
  {
    name: "users",
    path: "/users",
    meta: __nuxt_page_meta$v || {},
    component: () => import('./index-D24PZxqM.mjs')
  },
  {
    name: "basic-tables",
    path: "/basic-tables",
    component: () => import('./basic-tables-BVy-6iQO.mjs')
  },
  {
    name: "groups",
    path: "/groups",
    meta: __nuxt_page_meta$u || {},
    component: () => import('./index-CtXp0MZt.mjs')
  },
  {
    name: "library-id",
    path: "/library/:id()",
    meta: __nuxt_page_meta$t || {},
    component: () => import('./_id_-DaxLrbJ2.mjs')
  },
  {
    name: "tg-app",
    path: "/tg-app",
    meta: __nuxt_page_meta$s || {},
    component: () => import('./index-CMIkXg11.mjs')
  },
  {
    name: "form-elements",
    path: "/form-elements",
    component: () => import('./form-elements-Daux5hY-.mjs')
  },
  {
    name: "library",
    path: "/library",
    meta: __nuxt_page_meta$r || {},
    component: () => import('./index-D_Gi6TvA.mjs')
  },
  {
    name: "programs-id",
    path: "/programs/:id()",
    meta: __nuxt_page_meta$q || {},
    component: () => import('./_id_-B71YX_bH.mjs')
  },
  {
    name: "students-id",
    path: "/students/:id()",
    component: () => import('./_id_-a_RstPo8.mjs')
  },
  {
    name: "database",
    path: "/database",
    meta: __nuxt_page_meta$p || {},
    component: () => import('./index-fC5eACth.mjs')
  },
  {
    name: "programs",
    path: "/programs",
    meta: __nuxt_page_meta$o || {},
    component: () => import('./index-CiuROqnR.mjs')
  },
  {
    name: "test-bank-id",
    path: "/test-bank/:id()",
    meta: __nuxt_page_meta$n || {},
    component: () => import('./_id_-B-0xnZQN.mjs')
  },
  {
    name: "database-import",
    path: "/database/import",
    meta: __nuxt_page_meta$m || {},
    component: () => import('./import-CYO8o2Da.mjs')
  },
  {
    name: "my-certificates",
    path: "/my-certificates",
    meta: __nuxt_page_meta$l || {},
    component: () => import('./my-certificates-HCIVlLFQ.mjs')
  },
  {
    name: "my-courses-id",
    path: "/my-courses/:id()",
    meta: __nuxt_page_meta$k || {},
    component: () => import('./_id_-CagY2nwM.mjs')
  },
  {
    name: "programs-create",
    path: "/programs/create",
    meta: __nuxt_page_meta$j || {},
    component: () => import('./create-DY8nGcfg.mjs')
  },
  {
    name: "test-bank",
    path: "/test-bank",
    meta: __nuxt_page_meta$i || {},
    component: () => import('./index-B-OF2Cf0.mjs')
  },
  {
    name: "tests-take-id",
    path: "/tests/take/:id()",
    meta: __nuxt_page_meta$h || {},
    component: () => import('./_id_-DtBcRd-3.mjs')
  },
  {
    name: "instructors-id",
    path: "/instructors/:id()",
    component: () => import('./_id_-DIsAP5Rj.mjs')
  },
  {
    name: "my-courses",
    path: "/my-courses",
    meta: __nuxt_page_meta$g || {},
    component: () => import('./index-DCPAoZ9n.mjs')
  },
  {
    name: "groups-id",
    path: "/groups/:id()",
    meta: __nuxt_page_meta$f || {},
    component: () => import('./index-CGAkXx__.mjs')
  },
  {
    name: "attendance-pending",
    path: "/attendance/pending",
    meta: __nuxt_page_meta$e || {},
    component: () => import('./pending-BG_jusse.mjs')
  },
  {
    name: "programs-edit-id",
    path: "/programs/edit/:id()",
    meta: __nuxt_page_meta$d || {},
    component: () => import('./_id_-D6bmTEk0.mjs')
  },
  {
    name: "activity-logs",
    path: "/activity-logs",
    meta: __nuxt_page_meta$c || {},
    component: () => import('./index-Cy8fncjF.mjs')
  },
  {
    name: "groups-journal-slug",
    path: "/groups/journal/:slug()",
    meta: __nuxt_page_meta$b || {},
    component: () => import('./_slug_-D2XPPyLq.mjs')
  },
  {
    name: "instructor-stats",
    path: "/instructor/stats",
    meta: __nuxt_page_meta$a || {},
    component: () => import('./index-BH30ZpBr.mjs')
  },
  {
    name: "groups-id-certificates",
    path: "/groups/:id()/certificates",
    meta: __nuxt_page_meta$9 || {},
    component: () => import('./certificates-DBhVXgmx.mjs')
  },
  {
    name: "test-bank-templates-id",
    path: "/test-bank/templates/:id()",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./_id_-x-6W6D_K.mjs')
  },
  {
    name: "admin-attendance-requests",
    path: "/admin/attendance-requests",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./attendance-requests-Dmmizvfa.mjs')
  },
  {
    name: "admin-library-books",
    path: "/admin/library/books",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./index-DmEGwghg.mjs')
  },
  {
    name: "test-bank-templates",
    path: "/test-bank/templates",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./index-DUy-erRV.mjs')
  },
  {
    name: "certificates-templates",
    path: "/certificates/templates",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./index-DKw5nzFs.mjs')
  },
  {
    name: "database-import-certificates",
    path: "/database/import-certificates",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./import-certificates-BW1ZYB16.mjs')
  },
  {
    name: "certificates-templates-id",
    path: "/certificates/templates/:id()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./index-BaT1qu7c.mjs')
  },
  {
    name: "certificates-templates-id-editor",
    path: "/certificates/templates/:id()/editor",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./editor-Czc-_jXr.mjs')
  },
  {
    name: "admin-database-ai-import-certificates",
    path: "/admin/database/ai-import-certificates",
    meta: __nuxt_page_meta || {},
    component: () => import('./ai-import-certificates-C7c2NS9Z.mjs')
  }
];
...
var Permission = /* @__PURE__ */ ((Permission2) => {
  ...
  Permission2["COURSES_ARCHIVE"] = "courses:archive";
  ...
  Permission2["GROUPS_ARCHIVE"] = "groups:archive";
  ...
  Permission2["ATTENDANCE_MANAGE"] = "attendance:manage";
  ...
  Permission2["LIBRARY_VIEW"] = "library:view";
  Permission2["LIBRARY_MANAGE"] = "library:manage";
...
const PAGE_PERMISSIONS = [
  ...
  // Activity Logs
  { path: "/activity-logs", requiredPermissions: [
    "logs:view"
    /* LOGS_VIEW */
  ] },
  // Library
  { path: "/library", requiredPermissions: [
    "library:view"
    /* LIBRARY_VIEW */
  ] },
  { path: "/library/[id]", requiredPermissions: [
    "library:view"
    /* LIBRARY_VIEW */
  ] },
  {
...
const PUBLIC_PAGES = [
  ...
  "/environment",
  "/tg-app"
  // Telegram Mini App использует свою авторизацию
];
  ...
  if (config.requiredPermissions && config.requiredPermissions.length > 0) {
    if (!roleHasAllPermissions(userRole, config.requiredPermissions)) {
      const missing = config.requiredPermissions.filter(
        (p) => !roleHasPermission(userRole, p)
      );
      return {
        allowed: false,
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, from) => {
  ...
  if (!accessCheck.allowed) {
    console.warn(
      `[Auth Middleware] Доступ запрещён для ${user.email} (${user.role}) к ${to.path}: ${accessCheck.reason}`
    );
    return navigateTo({
      path: "/",
      query: {
...
const check_45database_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
...
const layouts = {
  ...
  default: defineAsyncComponent(() => import('./default-DxxyfFnh.mjs').then((m) => m.default || m)),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bv31PPlz.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dyqx5OVA.mjs'));
...
export { Permission as P, UserRole as U, __nuxt_component_0 as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, useAuth as e, roleHasPermission as f, getRolePermissions as g, roleHasAnyPermission as h, roleHasAllPermissions as i, useCookie as j, useState as k, useRoute as l, navigateTo as n, resolveRouteObject as r, useHead as u };
