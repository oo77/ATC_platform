        ...
        if (unref(filteredCertificates).length === 0) {
          ...
          ssrRenderList(unref(filteredCertificates), (cert) => {
            ...
            if (cert.status === "issued" && cert.id) {
              _push(`<a${ssrRenderAttr("href", `/api/certificates/download/${cert.id}`)} target="_blank" class="mt-4 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-primary text-white font-medium hover:bg-primary/90 transition-colors"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg> Скачать сертификат </a>`);
            } else {
...
//# sourceMappingURL=my-certificates-HCIVlLFQ.mjs.map
